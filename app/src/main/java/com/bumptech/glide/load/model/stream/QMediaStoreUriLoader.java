...
public final class QMediaStoreUriLoader<DataT> implements ModelLoader<Uri, DataT> {
    ...
    public static final class QMediaStoreUriFetcher<DataT> implements DataFetcher<DataT> {
        ...
        public QMediaStoreUriFetcher(Context context, ModelLoader<File, DataT> modelLoader, ModelLoader<Uri, DataT> modelLoader2, Uri uri, int i2, int i3, l lVar, Class<DataT> cls) {
        ...
        @Override // com.bumptech.glide.load.data.DataFetcher
        public void loadData(@NonNull f fVar, @NonNull DataFetcher.DataCallback<? super DataT> dataCallback) {
            try {
                ...
                if (this.isCancelled) {
                    ...
                    dataFetcherBuildDelegateFetcher.loadData(fVar, dataCallback);
                }
    ...
    public ModelLoader.LoadData<DataT> buildLoadData(@NonNull Uri uri, int i2, int i3, @NonNull l lVar) {
        return new ModelLoader.LoadData<>(new b(uri), new QMediaStoreUriFetcher(this.context, this.fileDelegate, this.uriDelegate, uri, i2, i3, lVar, this.dataClass));
    }
