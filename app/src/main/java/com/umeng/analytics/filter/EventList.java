...
public class EventList extends c implements FileLockCallback {
    ...
    public String toString() {
        ...
        StringBuilder sb = new StringBuilder("[");
        StringBuilder sbR = c.a.a.a.a.r("EventListName:");
        sbR.append(this.mEventListName);
        sbR.append(",");
        ...
        if (TextUtils.isEmpty(this.mEventList)) {
            ...
            StringBuilder sbR2 = c.a.a.a.a.r("listKeyValue:");
            sbR2.append(this.mEventList);
            sbR2.append("]");
        ...
        if (TextUtils.isEmpty(this.mEventListVersionKey)) {
            ...
            StringBuilder sbR3 = c.a.a.a.a.r("listKeyVer:");
            sbR3.append(this.mEventListVersionKey);
            sbR3.append("]");
            sb.append(sbR3.toString());
        }
        return sb.toString();
    }
}
