...
public class DBFileTraversalUtil {
    ...
    private static FileLockUtil f4977b = new FileLockUtil();
                ...
                public void run() {
                    try {
                        for (File file2 : file.listFiles()) {
                            if (file2.getName().endsWith(com.umeng.analytics.process.a.f4990d)) {
                                DBFileTraversalUtil.f4977b.doFileOperateion(file2, fileLockCallback);
