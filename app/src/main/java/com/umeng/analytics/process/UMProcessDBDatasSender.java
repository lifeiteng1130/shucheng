...
public class UMProcessDBDatasSender implements UMLogDataProtocol {
    ...
    public class ReplaceCallback implements FileLockCallback {
        ...
        public boolean onFileLock(String str) throws Throwable {
            ...
            if (str.startsWith(a.f4989c)) {
                str = str.replaceFirst(a.f4989c, "");
            }
            UMProcessDBHelper.getInstance(UMProcessDBDatasSender.this.mContext).deleteEventDatas(str.replace(a.f4990d, ""), null, null);
            return true;
        }
    ...
    private int defconProcesserHandler() throws Throwable {
        int iA = q.a().a(this.mContext);
        if (iA != 0) {
            try {
                DBFileTraversalUtil.traverseDBFiles(b.a(this.mContext), new ReplaceCallback(), null);
            } catch (Exception unused) {
            }
            UMProcessDBHelper.getInstance(this.mContext).deleteEventDatas(a.f4994h, null, null);
        }
        return iA;
    }
    ...
    private JSONObject generalHeader() {
        ...
        try {
            ...
            jSONObject.put(com.umeng.analytics.pro.c.f4798i, AnalyticsConfig.getVerticalType(this.mContext));
            String str2 = "9.3.8";
            ...
            SharedPreferences sharedPreferences = PreferenceWrapper.getDefault(this.mContext);
            jSONObject.put(com.umeng.analytics.pro.c.f4801l, UMEnvelopeBuild.imprintProperty(this.mContext, "pr_ve", null));
            jSONObject.put(com.umeng.analytics.pro.c.m, UMEnvelopeBuild.imprintProperty(this.mContext, "ud_da", null));
            ...
            if (TextUtils.isEmpty(strImprintProperty)) {
                ...
                jSONObject.put(com.umeng.analytics.pro.c.m, sharedPreferences.getString("vers_date", new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date(System.currentTimeMillis()))));
            }
        } catch (Throwable th) {
            th.printStackTrace();
        }
        ...
        try {
            ...
            if (jSONObject2.length() > 0) {
                if (jSONObject2.has("analytics")) {
                    ...
                    if (jSONObjectOptJSONObject.length() == 1 && (jSONObjectOptJSONObject.optJSONObject(com.umeng.analytics.pro.c.L) != null || !TextUtils.isEmpty(jSONObjectOptJSONObject.optString("userlevel")))) {
                        return null;
                    }
                    if (jSONObjectOptJSONObject.length() == 2 && jSONObjectOptJSONObject.optJSONObject(com.umeng.analytics.pro.c.L) != null && !TextUtils.isEmpty(jSONObjectOptJSONObject.optString("userlevel"))) {
                        return null;
                    }
                }
