...
public class ABTest implements d {
    ...
    public String getGroupInfo() {
        return !this.isInTest ? c.O : String.valueOf(this.mGroup);
    }
    ...
    public String toString() {
        StringBuilder sbR = a.r(" p13:");
        sbR.append(this.mProb13);
        sbR.append(" p07:");
        sbR.append(this.mProb07);
        sbR.append(" policy:");
        sbR.append(this.mPolicy);
        sbR.append(" interval:");
        sbR.append(this.mInterval);
        return sbR.toString();
    }
}
