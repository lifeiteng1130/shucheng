...
public class UMEnvelopeBuild {
    ...
    private static JSONObject add2CacheTable(Context context, JSONObject jSONObject, JSONObject jSONObject2, String str, String str2, String str3) {
        ...
        contentValues.put(am.f4694e, str2);
        contentValues.put(am.f4695f, hVarA.c(jSONObject.toString()));
        contentValues.put(am.f4696g, hVarA.c(jSONObject2.toString()));
        contentValues.put(am.f4697h, String.valueOf(jCurrentTimeMillis));
        contentValues.put(am.f4698i, uuidRandomUUID.toString());
        contentValues.put(am.f4699j, str);
        contentValues.put(am.f4700k, str3);
        ak.a(context).a(am.f4692c, contentValues);
    ...
    public static JSONObject buildEnvelopeWithExtHeader(Context context, JSONObject jSONObject, JSONObject jSONObject2) {
        return buildEnvelopeWithExtHeader(context, jSONObject, jSONObject2, UMServerURL.PATH_ANALYTICS, jSONObject.has("st") ? ai.aF : jSONObject2.has(ai.as) ? ai.aA : ai.at, "9.3.8");
    }
