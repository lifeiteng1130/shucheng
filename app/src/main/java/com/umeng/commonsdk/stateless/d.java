...
public class d {
    ...
    private static final byte[] f5238b = {10, 1, 11, 5, 4, bw.m, 7, 9, 23, 3, 1, 6, 8, 12, bw.f4789k, 91};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static Object f5239c = new Object();

    /* JADX INFO: renamed from: com.umeng.commonsdk.stateless.d$1, reason: invalid class name */
    /* JADX INFO: compiled from: UMSLUtils.java */
    ...
    /* JADX INFO: renamed from: com.umeng.commonsdk.stateless.d$2, reason: invalid class name */
    /* JADX INFO: compiled from: UMSLUtils.java */
    ...
    /* JADX INFO: renamed from: com.umeng.commonsdk.stateless.d$3, reason: invalid class name */
    /* JADX INFO: compiled from: UMSLUtils.java */
    public static class AnonymousClass3 implements java.util.Comparator<File>, j$.util.Comparator {
        @Override // java.util.Comparator, j$.util.Comparator
        /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
        public int compare(File file, File file2) {
            long jLastModified = file.lastModified() - file2.lastModified();
    ...
    /* JADX INFO: renamed from: com.umeng.commonsdk.stateless.d$4, reason: invalid class name */
    /* JADX INFO: compiled from: UMSLUtils.java */
    public static class AnonymousClass4 implements java.util.Comparator<File>, j$.util.Comparator {
        @Override // java.util.Comparator, j$.util.Comparator
        /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
        public int compare(File file, File file2) {
    ...
    /* JADX INFO: renamed from: com.umeng.commonsdk.stateless.d$6, reason: invalid class name */
    /* JADX INFO: compiled from: UMSLUtils.java */
    public static class AnonymousClass6 implements java.util.Comparator<File>, j$.util.Comparator {
        @Override // java.util.Comparator, j$.util.Comparator
        /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
        public int compare(File file, File file2) {
            if (file == null || file2 == null || file.lastModified() >= file2.lastModified()) {
            ...
            try {
                synchronized (f5239c) {
                    try {
                        ...
                        File file = new File(context.getFilesDir() + w.DEFAULT_PATH_SEPARATOR + a.f5218e);
                        if (!file.isDirectory()) {
                            file.mkdir();
                        }
                        File file2 = new File(file.getPath() + w.DEFAULT_PATH_SEPARATOR + str);
                        if (!file2.isDirectory()) {
                            file2.mkdir();
                        }
                        File file3 = new File(file2.getPath() + w.DEFAULT_PATH_SEPARATOR + str2);
                        if (!file3.exists()) {
                            file3.createNewFile();
                        }
    ...
    public static File[] c(Context context) {
        ...
        try {
            synchronized (f5239c) {
                String str = context.getApplicationContext().getFilesDir() + File.separator + a.f5219f;
                ...
                synchronized (f5239c) {
                    ...
                    if (fileArrListFiles != null && fileArrListFiles.length != 0) {
                        Arrays.sort(fileArrListFiles, new AnonymousClass3());
    ...
    */
    public static int a(android.content.Context r6, java.lang.String r7, java.lang.String r8, byte[] r9) {
        /*
            ...
            if (r6 == 0) goto L75
            r1 = 0
            java.lang.Object r2 = com.umeng.commonsdk.stateless.d.f5239c     // Catch: java.lang.Throwable -> L5d java.io.IOException -> L67
        ...
        try {
            synchronized (f5239c) {
                ...
                if (context != null && context.getApplicationContext() != null) {
                    String str = context.getApplicationContext().getFilesDir() + File.separator + a.f5218e;
                    if (!TextUtils.isEmpty(str)) {
                        ...
                        if (file2.isDirectory() && (fileArrListFiles = file2.listFiles()) != null && fileArrListFiles.length > 0) {
                            for (File file3 : fileArrListFiles) {
                                if (file3 != null && file3.isDirectory() && (fileArrListFiles2 = file3.listFiles()) != null && fileArrListFiles2.length > 0) {
                                    Arrays.sort(fileArrListFiles2, new AnonymousClass1());
    ...
    public static String a(Context context, boolean z) {
        ...
        try {
            if (z) {
                str = context.getApplicationContext().getFilesDir() + File.separator + a.f5218e;
            } else {
                str = context.getApplicationContext().getFilesDir() + File.separator + a.f5219f;
            }
            str2 = str;
            return str2;
        } catch (Throwable unused) {
    ...
    public static byte[] a(byte[] bArr, byte[] bArr2) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        cipher.init(1, new SecretKeySpec(bArr2, "AES"), new IvParameterSpec(f5238b));
