...
@Keep
public class PluginContext extends k {
    ...
    public Context createConfigurationContext(Configuration configuration) {
        ...
        try {
            ...
            a.a(contextCreateConfigurationContext.getClass(), "mResources").set(contextCreateConfigurationContext, this.mPlugin.mResources);
        }
    ...
    public Object getSystemService(String str) {
        ...
        if (this.mInflater == null) {
            ...
            f.z(layoutInflaterCloneInContext);
        }
