...
@Keep
public abstract class PluginService extends Service implements b {
    ...
    public class a implements InvocationHandler {
        ...
        public final Object invoke(Object obj, Method method, Object[] objArr) {
            ...
            return Boolean.valueOf(aVarM.f(new ComponentName(pluginService, pluginService.getClass().getName())));
        }
    }
