...
public final class DefaultDateTypeAdapter extends TypeAdapter<Date> {
    ...
    public String toString() {
        ...
        if (dateFormat instanceof SimpleDateFormat) {
            StringBuilder sbR = a.r("DefaultDateTypeAdapter(");
            sbR.append(((SimpleDateFormat) dateFormat).toPattern());
            sbR.append(')');
            return sbR.toString();
        }
        StringBuilder sbR2 = a.r("DefaultDateTypeAdapter(");
        sbR2.append(dateFormat.getClass().getSimpleName());
        sbR2.append(')');
