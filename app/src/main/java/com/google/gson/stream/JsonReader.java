        ...
        JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() { // from class: com.google.gson.stream.JsonReader.1
            ...
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                ...
                if (iDoPeek == 12) {
                    ...
                    StringBuilder sbR = a.r("Expected a name but was ");
                    sbR.append(jsonReader.peek());
                    sbR.append(jsonReader.locationString());
        ...
        while (true) {
            if (i2 == i3) {
                ...
                if (!fillBuffer(1)) {
                    ...
                    StringBuilder sbR = a.r("End of input");
                ...
                if (c4 < '0' || c4 > '9') {
                    if (c4 >= 'a' && c4 <= 'f') {
                        ...
                        if (c4 < 'A' || c4 > 'F') {
                            ...
                            sbR.append(new String(this.buffer, this.pos, 4));
    ...
    */
    ...
    public void beginArray() throws IOException {
        ...
        if (iDoPeek == 3) {
            ...
            StringBuilder sbR = a.r("Expected BEGIN_ARRAY but was ");
            sbR.append(peek());
            sbR.append(locationString());
            throw new IllegalStateException(sbR.toString());
        }
    ...
    public void beginObject() throws IOException {
        ...
        if (iDoPeek == 1) {
            ...
            StringBuilder sbR = a.r("Expected BEGIN_OBJECT but was ");
            sbR.append(peek());
            sbR.append(locationString());
            throw new IllegalStateException(sbR.toString());
        }
    ...
    public void endArray() throws IOException {
        ...
        if (iDoPeek != 4) {
            StringBuilder sbR = a.r("Expected END_ARRAY but was ");
            sbR.append(peek());
            sbR.append(locationString());
            throw new IllegalStateException(sbR.toString());
        }
    ...
    public void endObject() throws IOException {
        ...
        if (iDoPeek != 2) {
            StringBuilder sbR = a.r("Expected END_OBJECT but was ");
            sbR.append(peek());
            sbR.append(locationString());
            throw new IllegalStateException(sbR.toString());
        }
    ...
    public String getPath() {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            if (i4 == 1 || i4 == 2) {
                sbQ.append('[');
                sbQ.append(this.pathIndices[i3]);
                sbQ.append(']');
            } else if (i4 == 3 || i4 == 4 || i4 == 5) {
                sbQ.append('.');
                String[] strArr = this.pathNames;
                if (strArr[i3] != null) {
                    sbQ.append(strArr[i3]);
                }
            }
        }
        return sbQ.toString();
    ...
    public boolean nextBoolean() throws IOException {
        ...
        if (iDoPeek != 6) {
            StringBuilder sbR = a.r("Expected a boolean but was ");
            sbR.append(peek());
            sbR.append(locationString());
            throw new IllegalStateException(sbR.toString());
        }
    ...
    public double nextDouble() throws IOException {
        ...
        if (iDoPeek == 16) {
            ...
            StringBuilder sbR = a.r("Expected a double but was ");
            sbR.append(peek());
            sbR.append(locationString());
            throw new IllegalStateException(sbR.toString());
        }
    ...
    public int nextInt() throws IOException {
        ...
        if (iDoPeek == 15) {
            ...
            int i2 = (int) j2;
            if (j2 != i2) {
                StringBuilder sbR = a.r("Expected an int but was ");
                sbR.append(this.peekedLong);
                sbR.append(locationString());
                throw new NumberFormatException(sbR.toString());
            }
            this.peeked = 0;
        ...
        if (iDoPeek == 16) {
            ...
            if (iDoPeek != 8 && iDoPeek != 9 && iDoPeek != 10) {
                StringBuilder sbR2 = a.r("Expected an int but was ");
                sbR2.append(peek());
                sbR2.append(locationString());
        ...
        int i6 = (int) d2;
        if (i6 != d2) {
            StringBuilder sbR3 = a.r("Expected an int but was ");
            sbR3.append(this.peekedString);
            sbR3.append(locationString());
            throw new NumberFormatException(sbR3.toString());
        }
        this.peekedString = null;
        this.peeked = 0;
    ...
    public long nextLong() throws IOException {
        ...
        if (iDoPeek == 16) {
            ...
            if (iDoPeek != 8 && iDoPeek != 9 && iDoPeek != 10) {
                StringBuilder sbR = a.r("Expected a long but was ");
                sbR.append(peek());
                sbR.append(locationString());
                throw new IllegalStateException(sbR.toString());
            }
        ...
        long j3 = (long) d2;
        if (j3 != d2) {
            StringBuilder sbR2 = a.r("Expected a long but was ");
            sbR2.append(this.peekedString);
            sbR2.append(locationString());
    ...
    public void nextNull() throws IOException {
        ...
        if (iDoPeek != 7) {
            StringBuilder sbR = a.r("Expected null but was ");
            sbR.append(peek());
            sbR.append(locationString());
            throw new IllegalStateException(sbR.toString());
        }
    ...
    public String nextString() throws IOException {
        ...
        if (iDoPeek == 10) {
            ...
            if (iDoPeek != 16) {
                StringBuilder sbR = a.r("Expected a string but was ");
                sbR.append(peek());
                sbR.append(locationString());
                throw new IllegalStateException(sbR.toString());
            }
