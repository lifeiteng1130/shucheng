    ...
    public static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public String toString() {
            if (this.lowerBound != null) {
                StringBuilder sbR = a.r("? super ");
                sbR.append(C$Gson$Types.typeToString(this.lowerBound));
                return sbR.toString();
            }
            if (this.upperBound == Object.class) {
                return "?";
            }
            StringBuilder sbR2 = a.r("? extends ");
            sbR2.append(C$Gson$Types.typeToString(this.upperBound));
