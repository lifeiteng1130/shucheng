...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable, Map {
    ...
    /* JADX INFO: renamed from: com.google.gson.internal.LinkedTreeMap$1, reason: invalid class name */
    ...
    public class EntrySet extends AbstractSet<Map.Entry<K, V>> implements Set {
        public EntrySet() {
        }
