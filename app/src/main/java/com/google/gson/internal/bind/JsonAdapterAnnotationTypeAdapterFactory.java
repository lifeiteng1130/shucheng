    ...
    public TypeAdapter<?> getTypeAdapter(ConstructorConstructor constructorConstructor, Gson gson, TypeToken<?> typeToken, JsonAdapter jsonAdapter) {
        ...
        if (objConstruct instanceof TypeAdapter) {
            ...
            if (!z && !(objConstruct instanceof JsonDeserializer)) {
                StringBuilder sbR = a.r("Invalid attempt to bind an instance of ");
                sbR.append(objConstruct.getClass().getName());
                sbR.append(" as a @JsonAdapter for ");
                sbR.append(typeToken.toString());
                sbR.append(". @JsonAdapter value must be a TypeAdapter, TypeAdapterFactory, JsonSerializer or JsonDeserializer.");
