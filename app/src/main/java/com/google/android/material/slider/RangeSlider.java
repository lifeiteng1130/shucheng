...
public class RangeSlider extends BaseSlider<RangeSlider, ?, ?> {
    ...
    public void onRestoreInstanceState(@Nullable Parcelable parcelable) {
        ...
        this.g0 = rangeSliderState.a;
        int i2 = rangeSliderState.f2373b;
        this.h0 = i2;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        rangeSliderState.a = this.g0;
        rangeSliderState.f2373b = this.h0;
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(i4)) {
            TypedArray typedArrayObtainTypedArray = typedArrayObtainStyledAttributes.getResources().obtainTypedArray(typedArrayObtainStyledAttributes.getResourceId(i4, 0));
            ArrayList arrayList = new ArrayList();
            for (int i5 = 0; i5 < typedArrayObtainTypedArray.length(); i5++) {
                arrayList.add(Float.valueOf(typedArrayObtainTypedArray.getFloat(i5, -1.0f)));
            }
            setValues(arrayList);
        }
        this.g0 = typedArrayObtainStyledAttributes.getDimension(R$styleable.RangeSlider_minSeparation, 0.0f);
