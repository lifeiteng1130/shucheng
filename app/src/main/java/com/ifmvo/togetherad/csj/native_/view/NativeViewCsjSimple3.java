...
public final class NativeViewCsjSimple3 extends BaseNativeViewCsj {
    ...
    public NativeViewCsjSimple3(@Nullable l<? super String, v> lVar) {
        super(null, 1, null);
        this.mOnClose = lVar;
    }
    ...
    public void showNative(@NotNull final String adProviderType, @NotNull Object adObject, @NotNull final ViewGroup container, @Nullable NativeViewListener listener) {
        ...
        viewOnCreateSkipView.setOnClickListener(new View.OnClickListener() { // from class: com.ifmvo.togetherad.csj.native_.view.NativeViewCsjSimple3$showNative$$inlined$run$lambda$1
        ...
        CountDownTimer countDownTimer2 = new CountDownTimer(FocusMeteringAction.DEFAULT_AUTOCANCEL_DURATION, 1000L) { // from class: com.ifmvo.togetherad.csj.native_.view.NativeViewCsjSimple3.showNative.2
            @Override // android.os.CountDownTimer
            public void onFinish() {
                l lVar = NativeViewCsjSimple3.this.mOnClose;
                if (lVar != null) {
                }
            }
    ...
    public /* synthetic */ NativeViewCsjSimple3(l lVar, int i2, f.c0.c.f fVar) {
