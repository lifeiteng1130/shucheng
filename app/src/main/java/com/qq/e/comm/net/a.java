...
public class a {
    ...
    public static JSONObject a(DeviceStatus deviceStatus) throws JSONException {
        ...
        if (deviceStatus != null) {
            ...
            try {
                activeNetworkInfo = ((ConnectivityManager) appContext.getSystemService("connectivity")).getActiveNetworkInfo();
            } catch (Exception unused) {
            }
            String str = (activeNetworkInfo == null || activeNetworkInfo.getType() != 0) ? null : "" + ((TelephonyManager) appContext.getSystemService("phone")).getNetworkType();
    ...
    public static JSONObject b(DeviceStatus deviceStatus) throws JSONException {
        ...
        if (deviceStatus != null) {
            ...
            jSONObject.putOpt(ai.x, "android");
