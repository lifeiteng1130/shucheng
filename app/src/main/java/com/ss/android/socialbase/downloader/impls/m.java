...
/* JADX INFO: compiled from: IndependentDownloadBinder.java */
/* JADX INFO: loaded from: classes.dex */
public class m extends i.a {
    private static final String a = m.class.getSimpleName();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final com.ss.android.socialbase.downloader.downloader.m f3792b = new p(true);

    @Override // com.ss.android.socialbase.downloader.downloader.i
    public void a(com.ss.android.socialbase.downloader.model.a aVar) {
        com.ss.android.socialbase.downloader.downloader.m mVar = this.f3792b;
        if (mVar == null) {
            return;
        }
    ...
    @Override // com.ss.android.socialbase.downloader.downloader.i
    public void a(int i2, int i3, com.ss.android.socialbase.downloader.depend.i iVar, int i4, boolean z, boolean z2) {
        com.ss.android.socialbase.downloader.downloader.m mVar = this.f3792b;
        if (mVar == null) {
            return;
        }
