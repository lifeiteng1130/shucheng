...
public class DownloadTask {
    ...
    public void addListenerToDownloadingSameTask() {
        ...
        com.ss.android.socialbase.downloader.d.a.a(this.monitorDepend, this.downloadInfo, new BaseException(PointerIconCompat.TYPE_HELP, "has another same task, add Listener to old task"), 0);
    }
    ...
    public int download() {
        ...
        DownloadInfo downloadInfoB = com.ss.android.socialbase.downloader.downloader.c.x().b(this.downloadInfo.getId());
        if (downloadInfoB == null) {
            ...
            this.downloadInfo.copyTaskIdFromCacheData(downloadInfoB);
        }
        setChunkCalculator();
