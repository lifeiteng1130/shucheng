...
/* JADX INFO: compiled from: NotificationPusher.java */
...
public class h {
    ...
    private void b(@NonNull final com.ss.android.downloadad.api.a.b bVar, long j2) {
        final int iS = bVar.s();
        if (com.ss.android.socialbase.downloader.g.a.a(iS).b("notification_opt_2") != 1) {
            return;
        }
        a(iS);
        com.ss.android.downloadlib.d.a().a(new Runnable() { // from class: com.ss.android.downloadlib.c.h.1
            ...
            public void run() {
                DownloadInfo downloadInfo = Downloader.getInstance(j.getContext()).getDownloadInfo(iS);
    ...
    private void c(@NonNull final com.ss.android.downloadad.api.a.b bVar, long j2) {
        ...
        com.ss.android.downloadlib.d.a().a(new Runnable() { // from class: com.ss.android.downloadlib.c.h.2
            ...
            public void run() {
                ...
                com.ss.android.downloadlib.g.f.c(downloadInfo, jSONObject);
                if (l.b(bVar)) {
                    l.a(jSONObject, "error_code", Integer.valueOf(PointerIconCompat.TYPE_HAND));
                } else {
                    h.this.a(iS, bVar, jSONObject);
                }
                com.ss.android.downloadlib.d.a.a().b("download_notification_try_show", jSONObject, bVar);
    ...
    public void a(@NonNull final com.ss.android.downloadad.api.a.b bVar, long j2) {
        ...
        com.ss.android.downloadlib.d.a().a(new Runnable() { // from class: com.ss.android.downloadlib.c.h.3
            ...
            public void run() {
                ...
                com.ss.android.downloadlib.g.f.c(downloadInfo, jSONObject);
                if (l.c(bVar.e())) {
                    l.a(jSONObject, "error_code", Integer.valueOf(PointerIconCompat.TYPE_HELP));
                } else {
                    h.this.a(iS, bVar, jSONObject);
                }
                com.ss.android.downloadlib.d.a.a().b("download_notification_try_show", jSONObject, bVar);
    ...
    public void a(int i2, com.ss.android.downloadad.api.a.b bVar, JSONObject jSONObject) {
        ...
        if (downloadInfo == null) {
            l.a(jSONObject, "error_code", Integer.valueOf(WebSocketProtocol.CLOSE_NO_STATUS_CODE));
            return;
        }
