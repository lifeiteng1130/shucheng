...
/* JADX INFO: compiled from: DownloadSettingUtils.java */
...
public class e {
    ...
    public static long d() {
        long jOptLong = com.ss.android.downloadlib.addownload.j.i().optLong("start_install_interval");
        if (jOptLong == 0) {
            return 300000L;
        }
        return jOptLong;
    ...
    public static long e() {
        long jOptLong = com.ss.android.downloadlib.addownload.j.i().optLong("next_install_min_interval");
        if (jOptLong == 0) {
            return 10000L;
        }
        return jOptLong;
