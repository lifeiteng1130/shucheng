...
/* JADX INFO: compiled from: ReverseWifiHelper.java */
...
public class l {
    ...
    public static boolean a(final com.ss.android.downloadad.api.a.b bVar, DownloadInfo downloadInfo, int i2, final com.ss.android.downloadlib.addownload.d.c cVar) {
        ...
        boolean zB = com.ss.android.downloadlib.g.e.b(bVar);
        ...
        if (!zB || !a(i2) || com.ss.android.socialbase.downloader.i.f.b(j.getContext()) || downloadInfo.hasPauseReservedOnWifi()) {
            return false;
        }
