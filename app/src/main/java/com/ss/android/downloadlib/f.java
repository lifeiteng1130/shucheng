...
/* JADX INFO: compiled from: DownloadDispatcher.java */
...
public class f {
    ...
    private final List<com.ss.android.downloadlib.addownload.f> f3216c = new CopyOnWriteArrayList();

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private final Map<String, com.ss.android.downloadlib.addownload.f> f3217d = new ConcurrentHashMap();

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private final CopyOnWriteArrayList<Object> f3218e = new CopyOnWriteArrayList<>();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final Handler f3215b = new Handler(Looper.getMainLooper());
    ...
    private synchronized void b(Context context, int i2, DownloadStatusChangeListener downloadStatusChangeListener, DownloadModel downloadModel) {
        if (this.f3216c.size() <= 0) {
            c(context, i2, downloadStatusChangeListener, downloadModel);
        } else {
            com.ss.android.downloadlib.addownload.f fVarRemove = this.f3216c.remove(0);
            fVarRemove.b(context).b(i2, downloadStatusChangeListener).b(downloadModel).a();
            this.f3217d.put(downloadModel.getDownloadUrl(), fVarRemove);
        }
    }
    ...
    private void c(Context context, int i2, DownloadStatusChangeListener downloadStatusChangeListener, DownloadModel downloadModel) {
        ...
        this.f3217d.put(downloadModel.getDownloadUrl(), eVar);
    }

    private void d() {
        long jCurrentTimeMillis = System.currentTimeMillis();
        ArrayList arrayList = new ArrayList();
        for (com.ss.android.downloadlib.addownload.f fVar : this.f3216c) {
            if (!fVar.b() && jCurrentTimeMillis - fVar.d() > 300000) {
                fVar.h();
                arrayList.add(fVar);
            }
        }
        ...
        this.f3216c.removeAll(arrayList);
    }
    ...
    private void c() {
        long jCurrentTimeMillis = System.currentTimeMillis();
        if (jCurrentTimeMillis - this.f3219f < 300000) {
            return;
        }
        this.f3219f = jCurrentTimeMillis;
    ...
    public void a(Context context, int i2, DownloadStatusChangeListener downloadStatusChangeListener, DownloadModel downloadModel) {
        ...
        com.ss.android.downloadlib.addownload.f fVar = this.f3217d.get(downloadModel.getDownloadUrl());
        if (fVar != null) {
            fVar.b(context).b(i2, downloadStatusChangeListener).b(downloadModel).a();
        } else if (!this.f3216c.isEmpty()) {
    ...
    public void b(final DownloadInfo downloadInfo, final String str) {
        this.f3215b.post(new Runnable() { // from class: com.ss.android.downloadlib.f.4
            @Override // java.lang.Runnable
            public void run() {
                for (Object obj : f.this.f3218e) {
    ...
    public com.ss.android.downloadlib.addownload.e a(String str) {
        Map<String, com.ss.android.downloadlib.addownload.f> map = this.f3217d;
        if (map != null && map.size() != 0 && !TextUtils.isEmpty(str)) {
            com.ss.android.downloadlib.addownload.f fVar = this.f3217d.get(str);
    ...
    public void a(String str, int i2) {
        ...
        if (TextUtils.isEmpty(str) || (fVar = this.f3217d.get(str)) == null) {
            return;
        }
        if (fVar.a(i2)) {
    ...
    public void a(com.ss.android.download.api.download.a.a aVar) {
        if (aVar != null) {
            if (com.ss.android.socialbase.downloader.g.a.c().b("fix_listener_oom", false)) {
                this.f3218e.add(new SoftReference(aVar));
            } else {
                this.f3218e.add(aVar);
            }
        }
    }
    ...
    public void a(final DownloadModel downloadModel, @Nullable final DownloadController downloadController, @Nullable final DownloadEventConfig downloadEventConfig) {
        this.f3215b.post(new Runnable() { // from class: com.ss.android.downloadlib.f.1
            @Override // java.lang.Runnable
            public void run() {
                for (Object obj : f.this.f3218e) {
                    if (obj instanceof com.ss.android.download.api.download.a.a) {
    ...
    public void a(final DownloadInfo downloadInfo, final BaseException baseException, final String str) {
        this.f3215b.post(new Runnable() { // from class: com.ss.android.downloadlib.f.2
            @Override // java.lang.Runnable
            public void run() {
                for (Object obj : f.this.f3218e) {
                    if (obj instanceof com.ss.android.download.api.download.a.a) {
    ...
    public void a(final DownloadInfo downloadInfo, final String str) {
        this.f3215b.post(new Runnable() { // from class: com.ss.android.downloadlib.f.3
            @Override // java.lang.Runnable
            public void run() {
                for (Object obj : f.this.f3218e) {
                    if (obj instanceof com.ss.android.download.api.download.a.a) {
    ...
    public void a(final DownloadInfo downloadInfo) {
        this.f3215b.post(new Runnable() { // from class: com.ss.android.downloadlib.f.5
            @Override // java.lang.Runnable
            public void run() {
                for (Object obj : f.this.f3218e) {
                    if (obj instanceof com.ss.android.download.api.download.a.a) {
