...
public class AdDownloadModel implements DownloadModel {
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.putOpt(ai.o, this.mPackageName);
