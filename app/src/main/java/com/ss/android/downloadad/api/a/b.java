...
/* JADX INFO: compiled from: NativeDownloadModel.java */
...
public class b implements a {
    ...
    public final AtomicBoolean f2947c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final AtomicBoolean f2948d;
    ...
    private b() {
        ...
        this.a = true;
        this.f2946b = true;
        this.f2947c = new AtomicBoolean(false);
        this.f2948d = new AtomicBoolean(false);
        this.Q = 1;
        this.T = true;
        this.Z = -1L;
    }
    ...
    public JSONObject ae() {
        ...
        try {
            jSONObject.put("mId", this.f2949e);
            jSONObject.put("mExtValue", this.f2950f);
            jSONObject.put("mLogExtra", this.f2951g);
            jSONObject.put("mDownloadStatus", this.f2952h);
            jSONObject.put("mPackageName", this.f2953i);
            ...
            jSONObject.put("mDownloadUrl", this.f2954j);
            jSONObject.put("mEnableBackDialog", this.x);
            jSONObject.put("hasSendInstallFinish", this.f2947c.get());
            jSONObject.put("hasSendDownloadFailedFinally", this.f2948d.get());
            jSONObject.put("mLastFailedErrCode", this.E);
            jSONObject.put("mLastFailedErrMsg", this.F);
            jSONObject.put("mOpenUrl", this.f2955k);
            ...
            jSONObject.put("webUrl", this.f2956l);
    ...
    public AdDownloadModel af() {
        return new AdDownloadModel.Builder().setAdId(this.f2949e).setExtraValue(this.f2950f).setLogExtra(this.f2951g).setPackageName(this.f2953i).setExtra(this.v).setIsAd(this.t).setVersionCode(this.p).setVersionName(this.q).setDownloadUrl(this.f2954j).setModelType(this.m).setMimeType(this.H).setAppName(this.r).setAppIcon(this.s).setDeepLink(new DeepLink(this.f2955k, this.f2956l, null)).build();
    }
    ...
    public AdDownloadController ah() {
        return new AdDownloadController.Builder().setIsEnableBackDialog(this.x).setLinkMode(this.n).setDownloadMode(this.o).setEnableShowComplianceDialog(this.T).setEnableAH(this.a).setEnableAM(this.f2946b).build();
    }
    ...
    public static b b(JSONObject jSONObject) {
        ...
        try {
            ...
            bVar.f2947c.set(jSONObject.optBoolean("hasSendInstallFinish"));
            bVar.f2948d.set(jSONObject.optBoolean("hasSendDownloadFailedFinally"));
    ...
    public b(DownloadModel downloadModel, DownloadEventConfig downloadEventConfig, DownloadController downloadController, int i2) {
        ...
        this.T = true;
        this.Z = -1L;
        this.f2949e = downloadModel.getId();
        this.f2950f = downloadModel.getExtraValue();
        this.f2951g = downloadModel.getLogExtra();
        this.f2953i = downloadModel.getPackageName();
        ...
        this.f2954j = downloadModel.getDownloadUrl();
        if (downloadModel.getDeepLink() != null) {
            this.f2955k = downloadModel.getDeepLink().getOpenUrl();
            this.f2956l = downloadModel.getDeepLink().getWebUrl();
        }
        ...
        this.f2946b = downloadController.enableAM();
        this.w = i2;
