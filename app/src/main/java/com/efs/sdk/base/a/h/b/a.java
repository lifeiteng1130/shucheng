...
public final class a implements IHttpUtil {
    ...
    /* JADX INFO: renamed from: com.efs.sdk.base.a.h.b.a$a, reason: collision with other inner class name */
    ...
    private static void b(HttpURLConnection httpURLConnection) {
        if (httpURLConnection != null) {
            ...
            try {
                com.efs.sdk.base.a.h.b.a(httpURLConnection.getInputStream());
        ...
        while (true) {
            ...
            try {
                try {
                    ...
                    httpURLConnectionA.setRequestMethod(NetworkRequestAsyncTask.REQUEST_METHOD);
                ...
                com.efs.sdk.base.a.h.d.b("efs.util.http", "post file '" + str + "' error", e2);
            } catch (UnknownHostException e3) {
                httpResponse.setHttpCode(-2);
                com.efs.sdk.base.a.h.d.b("efs.util.http", "get request '" + str + "' error， maybe network is disconnect", e3);
            }
            b(httpURLConnectionA);
        }
        ...
        try {
            try {
                ...
                try {
                    ...
                    e = e2;
                    httpResponse.setHttpCode(-3);
                    com.efs.sdk.base.a.h.d.b("efs.util.http", "post file '" + str + "' error", e);
                    map = map;
                } catch (UnknownHostException e3) {
                    e = e3;
                    httpResponse.setHttpCode(-2);
                    com.efs.sdk.base.a.h.d.b("efs.util.http", "post data to '" + str + "' error， maybe network is disconnect", e);
                    map = map;
                } catch (Throwable th) {
                    th = th;
                    com.efs.sdk.base.a.h.d.b("efs.util.http", "post data '" + str + "' error", th);
                    map = map;
                }
            } finally {
                com.efs.sdk.base.a.h.b.a(outputStream);
                b(map);
            }
    ...
    private static HttpResponse a(HttpURLConnection httpURLConnection) {
        ...
        while (true) {
            try {
                ...
                th = th4;
                try {
                    com.efs.sdk.base.a.h.d.b("efs.util.http", "get response error", th);
                } finally {
                    com.efs.sdk.base.a.h.b.a(inputStream);
                    com.efs.sdk.base.a.h.b.a(byteArrayOutputStream);
                }
            }
            return httpResponse;
        }
        ...
        try {
            try {
                ...
                try {
                    ...
                    httpURLConnectionA.setRequestProperty("Connection", "close");
                    httpURLConnectionA.setRequestProperty(HttpConnection.CONTENT_TYPE, "multipart/form-data;boundary=----WebKitFormBoundaryP0Rfzlf32iRoMhmb");
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (bArr == 0) {
                                if (file != null && file.exists()) {
                                    ...
                                    try {
                                        ...
                                        while (true) {
                                            int i2 = fileInputStream4.read(bArr2);
                                            if (i2 == -1) {
                                                break;
                                            }
                                        ...
                                        httpResponse.setHttpCode(-2);
                                        com.efs.sdk.base.a.h.d.b("efs.util.http", "post file '" + str + "' error， maybe network is disconnect", e);
                                        bArr = fileInputStream2;
                                    } catch (Throwable th) {
                                        th = th;
                                        httpURLConnection = httpURLConnectionA;
                                        fileInputStream = fileInputStream4;
                                        com.efs.sdk.base.a.h.d.b("efs.util.http", "post file '" + str + "' error", th);
                                        bArr = fileInputStream;
                                    }
                                }
                                b(httpURLConnectionA);
                                com.efs.sdk.base.a.h.b.a(outputStream);
                                com.efs.sdk.base.a.h.b.a(dataOutputStream);
                                com.efs.sdk.base.a.h.b.a((Closeable) null);
                                return httpResponse;
                            }
                            ...
                            com.efs.sdk.base.a.h.b.a(outputStream);
                            com.efs.sdk.base.a.h.b.a(dataOutputStream);
                            com.efs.sdk.base.a.h.b.a(fileInputStream5);
                        } catch (SocketTimeoutException e4) {
                            e = e4;
                ...
                com.efs.sdk.base.a.h.b.a(outputStream);
                com.efs.sdk.base.a.h.b.a(dataOutputStream);
                com.efs.sdk.base.a.h.b.a((Closeable) bArr);
            }
