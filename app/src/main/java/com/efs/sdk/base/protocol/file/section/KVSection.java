...
public class KVSection extends AbsSection {
    ...
    public KVSection putNum(String str, long j2) {
        this.dataMap.put(ILogProtocol.KEY_PREFIX_NUM.concat(String.valueOf(str)), Long.valueOf(j2));
        return this;
    }
    ...
    public KVSection putTimestamp(String str, long j2) {
        this.dataMap.put(ILogProtocol.KEY_PREFIX_TIMESTAMP.concat(String.valueOf(str)), Long.valueOf(j2));
        return this;
    }
}
