...
public class XpathLexer extends s {
    ...
    public XpathLexer(k.a.a.a.g gVar) {
        super(gVar);
        this._interp = new c0(this, _ATN, _decisionToDFA, _sharedContextCache);
    }
