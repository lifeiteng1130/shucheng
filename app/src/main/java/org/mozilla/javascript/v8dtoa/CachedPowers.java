...
public class CachedPowers {
    ...
    public static class CachedPower {
        ...
        public CachedPower(long j2, short s, short s2) {
            this.significand = j2;
    ...
    public static int getCachedPower(int i2, int i3, int i4, DiyFp diyFp) {
        CachedPower cachedPower = CACHED_POWERS[(((((int) Math.ceil(((double) (((i3 - i2) + 64) - 1)) * 0.30102999566398114d)) + 308) - 1) / 8) + 1];
