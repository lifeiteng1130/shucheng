...
public class TreeTableModelAdapter extends AbstractTableModel {
    ...
    public Class<?> getColumnClass(int i2) {
        return this.treeTableModel.getColumnClass(i2);
    }
    ...
    public String getColumnName(int i2) {
        return this.treeTableModel.getColumnName(i2);
    }
    ...
    public Object getValueAt(int i2, int i3) {
        return this.treeTableModel.getValueAt(nodeForRow(i2), i3);
    }

    public boolean isCellEditable(int i2, int i3) {
        return this.treeTableModel.isCellEditable(nodeForRow(i2), i3);
    }

    public Object nodeForRow(int i2) {
        return this.tree.getPathForRow(i2).getLastPathComponent();
    }
