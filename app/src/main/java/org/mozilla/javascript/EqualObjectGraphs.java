...
public final class EqualObjectGraphs {
    ...
    private boolean equalObjectArrays(Object[] objArr, Object[] objArr2) {
        ...
        for (int i2 = 0; i2 < objArr.length; i2++) {
            if (!equalGraphs(objArr[i2], objArr2[i2])) {
                return false;
            }
        }
        return true;
    ...
    private boolean equalScriptables(Scriptable scriptable, Scriptable scriptable2) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            if (!equalGraphs(getValue(scriptable, sortedIds[i2]), getValue(scriptable2, sortedIds2[i2]))) {
                return false;
            }
        }
    ...
    public static <T> T withThreadLocal(j$.util.function.Function<EqualObjectGraphs, T> function) {
        ...
        try {
            T t = (T) function.apply(equalObjectGraphs2);
