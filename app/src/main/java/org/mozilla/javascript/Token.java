...
public class Token {
    ...
    public static boolean isValidToken(int i2) {
        return i2 >= -1 && i2 <= 167;
    }

    public static String keywordToName(int i2) {
        if (i2 == 4) {
            return "return";
        }
        if (i2 == 50) {
    ...
    public static String typeToName(int i2) {
        switch (i2) {
            case -1:
                return "ERROR";
            case 0:
            ...
            case 151:
                return "TO_DOUBLE";
            case 152:
                return NetworkRequestAsyncTask.REQUEST_METHOD;
            case 153:
                return "SET";
            case 154:
                return "LET";
