...
public class d {
    ...
    public static final String[][] f8557i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public static final String[][] f8558j;
    ...
    public static String[][] a() {
        return (String[][]) f8555g.clone();
    }

    public static String[][] b() {
        return (String[][]) f8553e.clone();
    }

    public static String[][] c() {
        return (String[][]) f8554f.clone();
    }

    public static String[][] d() {
        return (String[][]) f8557i.clone();
    }
