...
public class h extends b {
    ...
    public h(a... aVarArr) {
        if (aVarArr.length > 0) {
            this.f8568b = EnumSet.copyOf((Collection) Arrays.asList(aVarArr));
        } else {
            this.f8568b = EnumSet.copyOf((Collection) Collections.singletonList(a.semiColonRequired));
        }
    }
