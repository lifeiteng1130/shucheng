...
public final class OpenJSSEPlatform extends Platform {
    ...
    public SSLContext newSSLContext() throws NoSuchAlgorithmException {
        ...
        j.d(sSLContext, "SSLContext.getInstance(\"TLSv1.3\", provider)");
        return sSLContext;
    }
