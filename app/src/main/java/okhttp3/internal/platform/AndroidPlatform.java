...
public final class AndroidPlatform extends Platform {
    ...
    public static final /* data */ class CustomTrustRootIndex implements TrustRootIndex {
        ...
        public String toString() {
            StringBuilder sbR = a.r("CustomTrustRootIndex(trustManager=");
            sbR.append(this.trustManager);
            sbR.append(", findByIssuerAndSignatureMethod=");
            sbR.append(this.findByIssuerAndSignatureMethod);
            sbR.append(")");
            return sbR.toString();
        }
    }
    ...
    public AndroidPlatform() {
        List listV = e.v(StandardAndroidSocketAdapter.Companion.buildIfSupported$default(StandardAndroidSocketAdapter.INSTANCE, null, 1, null), new DeferredSocketAdapter(AndroidSocketAdapter.INSTANCE.getPlayProviderFactory()), new DeferredSocketAdapter(ConscryptSocketAdapter.INSTANCE.getFactory()), new DeferredSocketAdapter(BouncyCastleSocketAdapter.INSTANCE.getFactory()));
