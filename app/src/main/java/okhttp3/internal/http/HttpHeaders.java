...
public final class HttpHeaders {
    ...
    public static final List<Challenge> parseChallenges(@NotNull Headers headers, @NotNull String str) {
        j.e(headers, "$this$parseChallenges");
        j.e(str, "headerName");
        ArrayList arrayList = new ArrayList();
        int size = headers.size();
        for (int i2 = 0; i2 < size; i2++) {
            if (k.i(str, headers.name(i2), true)) {
                try {
    ...
    public static final boolean promisesBody(@NotNull Response response) {
        j.e(response, "$this$promisesBody");
        if (j.a(response.request().method(), "HEAD")) {
            return false;
        }
        int iCode = response.code();
        return (((iCode >= 100 && iCode < 200) || iCode == 204 || iCode == 304) && Util.headersContentLength(response) == -1 && !k.i("chunked", Response.header$default(response, "Transfer-Encoding", null, 2, null), true)) ? false : true;
    }
    ...
    */
    private static final void readChallengeHeader(okio.Buffer r7, java.util.List<okhttp3.Challenge> r8) throws java.io.EOFException {
        ...
        L41:
            ...
            java.lang.String r4 = "="
            java.lang.String r4 = f.h0.k.B(r4, r5)
            r3.append(r4)
    ...
    public static final void receiveHeaders(@NotNull CookieJar cookieJar, @NotNull HttpUrl httpUrl, @NotNull Headers headers) {
        j.e(cookieJar, "$this$receiveHeaders");
        j.e(httpUrl, "url");
        j.e(headers, "headers");
