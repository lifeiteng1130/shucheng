...
public final class CipherSuite {
    ...
    static {
        ...
        TLS_RSA_WITH_CAMELLIA_256_CBC_SHA = companion2.init("TLS_RSA_WITH_CAMELLIA_256_CBC_SHA", Token.TARGET);
        TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA = companion2.init("TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA", Token.EXPR_RESULT);
        TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA = companion2.init("TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA", Token.JSR);
        TLS_PSK_WITH_RC4_128_SHA = companion2.init("TLS_PSK_WITH_RC4_128_SHA", Token.TYPEOFNAME);
        TLS_PSK_WITH_3DES_EDE_CBC_SHA = companion2.init("TLS_PSK_WITH_3DES_EDE_CBC_SHA", Token.USE_STACK);
        TLS_PSK_WITH_AES_128_CBC_SHA = companion2.init("TLS_PSK_WITH_AES_128_CBC_SHA", 140);
        TLS_PSK_WITH_AES_256_CBC_SHA = companion2.init("TLS_PSK_WITH_AES_256_CBC_SHA", Token.SETELEM_OP);
        ...
        TLS_DHE_RSA_WITH_AES_256_GCM_SHA384 = companion2.init("TLS_DHE_RSA_WITH_AES_256_GCM_SHA384", Token.LETEXPR);
        TLS_DHE_DSS_WITH_AES_128_GCM_SHA256 = companion2.init("TLS_DHE_DSS_WITH_AES_128_GCM_SHA256", Token.COMMENT);
        TLS_DHE_DSS_WITH_AES_256_GCM_SHA384 = companion2.init("TLS_DHE_DSS_WITH_AES_256_GCM_SHA384", Token.GENEXPR);
        TLS_DH_anon_WITH_AES_128_GCM_SHA256 = companion2.init("TLS_DH_anon_WITH_AES_128_GCM_SHA256", 166);
        TLS_DH_anon_WITH_AES_256_GCM_SHA384 = companion2.init("TLS_DH_anon_WITH_AES_256_GCM_SHA384", Token.LAST_TOKEN);
    ...
    @Deprecated(level = a.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "javaName", imports = {}))
