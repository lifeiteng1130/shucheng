...
object AppUpdateGitHub : AppUpdate.AppUpdateInterface {
    ...
    private suspend fun getLatestRelease(): List<AppReleaseInfo> {
        val url = if (checkVariant == AppVariant.OFFICIAL)
            "https://api.github.com/repos/lifeiteng1130/shucheng/releases/latest"
        else
            "https://api.github.com/repos/lifeiteng1130/shucheng/releases"
    ...
    suspend fun getReleaseByTag(tag: String): AppUpdate.UpdateInfo? {
        val url = "https://api.github.com/repos/lifeiteng1130/shucheng/releases/tags/$tag"
        val res = okHttpClient.newCallResponse { url(url) }
