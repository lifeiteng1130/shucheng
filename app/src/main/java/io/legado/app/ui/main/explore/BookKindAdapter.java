...
import io.legado.app.databinding.LayoutKindItemBinding;
...
/* JADX INFO: compiled from: BookKindAdapter.kt */
/* JADX INFO: loaded from: classes3.dex */
@Metadata(bv = {1, 0, 3}, d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001:\u0001\u0014B\u001f\u0012\u0006\u0010\u0011\u001a\u00020\u0010\u0012\u0006\u0010\u000b\u001a\u00020\b\u0012\u0006\u0010\u000f\u001a\u00020\f¢\u0006\u0004\b\u0012\u0010\u0013R\u0016\u0010\u0007\u001a\u00020\u00048\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0005\u0010\u0006R\u0016\u0010\u000b\u001a\u00020\b8\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\t\u0010\nR\u0016\u0010\u000f\u001a\u00020\f8\u0002@\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\r\u0010\u000e¨\u0006\u0015"}, d2 = {"Lio/legado/app/ui/main/explore/BookKindAdapter;", "Lio/legado/app/base/adapter/RecyclerAdapter;", "Lio/legado/app/data/entities/BookSource$ExploreKind;", "Lio/legado/app/databinding/LayoutKindItemBinding;", "", "h", OptRuntime.GeneratorState.resumptionPoint_TYPE, "currentPosition", "Lg/b/a0;", "f", "Lg/b/a0;", "scope", "Lio/legado/app/ui/main/explore/BookKindAdapter$a;", "g", "Lio/legado/app/ui/main/explore/BookKindAdapter$a;", "callBack", "Landroid/content/Context;", c.R, "<init>", "(Landroid/content/Context;Lg/b/a0;Lio/legado/app/ui/main/explore/BookKindAdapter$a;)V", ai.at, "app_adsRelease"}, k = 1, mv = {1, 5, 1})
public final class BookKindAdapter extends RecyclerAdapter<BookSource.ExploreKind, LayoutKindItemBinding> {
    ...
    public BookKindAdapter(@NotNull Context context, @NotNull a0 a0Var, @NotNull a aVar) {
        super(context);
        j.e(context, c.R);
        j.e(a0Var, "scope");
        j.e(aVar, "callBack");
    ...
    public void i(ItemViewHolder itemViewHolder, ViewBinding viewBinding, BookSource.ExploreKind exploreKind, List list, int i2) {
        LayoutKindItemBinding layoutKindItemBinding = (LayoutKindItemBinding) viewBinding;
        BookSource.ExploreKind exploreKind2 = exploreKind;
        j.e(itemViewHolder, "holder");
        j.e(layoutKindItemBinding, "binding");
        j.e(exploreKind2, "exploreKind");
        j.e(list, "payloads");
        layoutKindItemBinding.f6860b.setText(exploreKind2.getTitle());
        ...
        layoutKindItemBinding.f6860b.setTextColor(aVar.a());
        if (this.currentPosition == i2) {
            layoutKindItemBinding.f6860b.setSelected(true);
        } else {
            layoutKindItemBinding.f6860b.setSelected(false);
        }
    }
    ...
    public ViewBinding q(ViewGroup viewGroup) {
        ...
        View viewInflate = this.inflater.inflate(R.layout.layout_kind_item, viewGroup, false);
        ...
        LayoutKindItemBinding layoutKindItemBinding = new LayoutKindItemBinding((LinearLayout) viewInflate, textView);
    ...
    public void w(final ItemViewHolder itemViewHolder, ViewBinding viewBinding) {
        ...
        j.e(itemViewHolder, "holder");
        j.e(layoutKindItemBinding, "binding");
        layoutKindItemBinding.f6860b.setOnClickListener(new View.OnClickListener() { // from class: e.a.a.g.h.h.a
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                BookKindAdapter bookKindAdapter = this.a;
                ItemViewHolder itemViewHolder2 = itemViewHolder;
                f.c0.c.j.e(bookKindAdapter, "this$0");
                f.c0.c.j.e(itemViewHolder2, "$holder");
                bookKindAdapter.callBack.H(itemViewHolder2.getAdapterPosition());
            }
        });
    }
}
