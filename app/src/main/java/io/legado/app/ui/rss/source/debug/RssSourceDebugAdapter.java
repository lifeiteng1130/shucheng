...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\u000f\u0012\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0006\u0010\u0007¨\u0006\b"}, d2 = {"Lio/legado/app/ui/rss/source/debug/RssSourceDebugAdapter;", "Lio/legado/app/base/adapter/RecyclerAdapter;", "", "Lio/legado/app/databinding/ItemLogBinding;", "Landroid/content/Context;", c.R, "<init>", "(Landroid/content/Context;)V", "app_adsRelease"}, k = 1, mv = {1, 5, 1})
public final class RssSourceDebugAdapter extends RecyclerAdapter<String, ItemLogBinding> {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RssSourceDebugAdapter(@NotNull Context context) {
        super(context);
        j.e(context, c.R);
    }
    ...
    public void i(ItemViewHolder itemViewHolder, ViewBinding viewBinding, String str, List list, int i2) {
        ...
        if (itemLogBinding.f6809b.getTag(R.id.tag1) == null) {
            e.a.a.g.k.d.a.c cVar = new e.a.a.g.k.d.a.c(itemLogBinding);
            itemLogBinding.f6809b.addOnAttachStateChangeListener(cVar);
            itemLogBinding.f6809b.setTag(R.id.tag1, cVar);
        }
