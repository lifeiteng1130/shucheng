...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\n\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001B\u0007¢\u0006\u0004\b\u000e\u0010\u000fJ\u0019\u0010\u0007\u001a\u00020\u00062\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004H\u0016¢\u0006\u0004\b\u0007\u0010\bR\u001d\u0010\r\u001a\u00020\u00038T@\u0014X\u0094\u0084\u0002¢\u0006\f\n\u0004\b\t\u0010\n\u001a\u0004\b\u000b\u0010\f¨\u0006\u0010"}, d2 = {"Lio/legado/app/ui/association/ImportRssSourceActivity;", "Lio/legado/app/base/VMBaseActivity;", "Lio/legado/app/databinding/ActivityTranslucenceBinding;", "Lio/legado/app/ui/association/ImportRssSourceViewModel;", "Landroid/os/Bundle;", "savedInstanceState", "Lf/v;", "O0", "(Landroid/os/Bundle;)V", "h", "Lf/e;", "T0", "()Lio/legado/app/ui/association/ImportRssSourceViewModel;", "viewModel", "<init>", "()V", "app_adsRelease"}, k = 1, mv = {1, 5, 1})
public final class ImportRssSourceActivity extends VMBaseActivity<ActivityTranslucenceBinding, ImportRssSourceViewModel> {
    ...
    public ImportRssSourceActivity() {
        ...
        this.viewModel = new ViewModelLazy(v.a(ImportRssSourceViewModel.class), new b(this), new a(this));
    }
    ...
    public void O0(@Nullable Bundle savedInstanceState) {
        ...
        T0().errorLiveData.observe(this, new Observer() { // from class: e.a.a.g.b.k
            /* JADX WARN: Multi-variable type inference failed */
            @Override // androidx.view.Observer
            public final void onChanged(Object obj) {
                ImportRssSourceActivity importRssSourceActivity = this.a;
                String str2 = (String) obj;
                int i2 = ImportRssSourceActivity.f7002g;
                f.c0.c.j.e(importRssSourceActivity, "this$0");
                ((ActivityTranslucenceBinding) importRssSourceActivity.K0()).f6569b.a();
                f.c0.c.j.d(str2, "it");
                ((e.a.a.e.a.i) c.b.a.m.f.g0(importRssSourceActivity, importRssSourceActivity.getString(R.string.error), str2, new b0(importRssSourceActivity))).p();
            }
        });
        T0().successLiveData.observe(this, new Observer() { // from class: e.a.a.g.b.l
            /* JADX WARN: Multi-variable type inference failed */
            @Override // androidx.view.Observer
            public final void onChanged(Object obj) {
                ImportRssSourceActivity importRssSourceActivity = this.a;
                ...
                f.c0.c.j.d(num, "it");
                if (num.intValue() <= 0) {
                    String string = importRssSourceActivity.getString(R.string.wrong_format);
                    f.c0.c.j.d(string, "getString(R.string.wrong_format)");
                    ((e.a.a.e.a.i) c.b.a.m.f.g0(importRssSourceActivity, importRssSourceActivity.getString(R.string.error), string, new b0(importRssSourceActivity))).p();
                } else {
                    ImportRssSourceDialog importRssSourceDialog = new ImportRssSourceDialog();
                    FragmentManager supportFragmentManager = importRssSourceActivity.getSupportFragmentManager();
    ...
    @NotNull
    public ImportRssSourceViewModel T0() {
