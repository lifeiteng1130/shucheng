...
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000T\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\b\u0018\u00002\u00020\u00012\u00020\u0002:\u0001(B\u0007¢\u0006\u0004\b'\u0010\u0005J\u000f\u0010\u0004\u001a\u00020\u0003H\u0016¢\u0006\u0004\b\u0004\u0010\u0005J-\u0010\r\u001a\u0004\u0018\u00010\f2\u0006\u0010\u0007\u001a\u00020\u00062\b\u0010\t\u001a\u0004\u0018\u00010\b2\b\u0010\u000b\u001a\u0004\u0018\u00010\nH\u0016¢\u0006\u0004\b\r\u0010\u000eJ!\u0010\u0010\u001a\u00020\u00032\u0006\u0010\u000f\u001a\u00020\f2\b\u0010\u000b\u001a\u0004\u0018\u00010\nH\u0016¢\u0006\u0004\b\u0010\u0010\u0011J\u0019\u0010\u0015\u001a\u00020\u00142\b\u0010\u0013\u001a\u0004\u0018\u00010\u0012H\u0016¢\u0006\u0004\b\u0015\u0010\u0016R\u001d\u0010\u001c\u001a\u00020\u00178B@\u0002X\u0082\u0084\u0002¢\u0006\f\n\u0004\b\u0018\u0010\u0019\u001a\u0004\b\u001a\u0010\u001bR\u001a\u0010 \u001a\u00060\u001dR\u00020\u00008\u0002@\u0002X\u0082.¢\u0006\u0006\n\u0004\b\u001e\u0010\u001fR\u001d\u0010&\u001a\u00020!8B@\u0002X\u0082\u0084\u0002¢\u0006\f\n\u0004\b\"\u0010#\u001a\u0004\b$\u0010%¨\u0006)"}, d2 = {"Lio/legado/app/ui/book/source/manage/GroupManageDialog;", "Landroidx/fragment/app/DialogFragment;", "Landroidx/appcompat/widget/Toolbar$OnMenuItemClickListener;", "Lf/v;", "onStart", "()V", "Landroid/view/LayoutInflater;", "inflater", "Landroid/view/ViewGroup;", "container", "Landroid/os/Bundle;", "savedInstanceState", "Landroid/view/View;", "onCreateView", "(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;", "view", "onViewCreated", "(Landroid/view/View;Landroid/os/Bundle;)V", "Landroid/view/MenuItem;", "item", "", "onMenuItemClick", "(Landroid/view/MenuItem;)Z", "Lio/legado/app/ui/book/source/manage/BookSourceViewModel;", "b", "Lf/e;", "getViewModel", "()Lio/legado/app/ui/book/source/manage/BookSourceViewModel;", "viewModel", "Lio/legado/app/ui/book/source/manage/GroupManageDialog$a;", ai.aD, "Lio/legado/app/ui/book/source/manage/GroupManageDialog$a;", "adapter", "Lio/legado/app/databinding/DialogRecyclerViewBinding;", "d", "Lio/legado/app/utils/viewbindingdelegate/ViewBindingProperty;", "O", "()Lio/legado/app/databinding/DialogRecyclerViewBinding;", "binding", "<init>", ai.at, "app_adsRelease"}, k = 1, mv = {1, 5, 1})
public final class GroupManageDialog extends DialogFragment implements Toolbar.OnMenuItemClickListener {
    ...
    @NotNull
    public final e viewModel = FragmentViewModelLazyKt.createViewModelLazy(this, v.a(BookSourceViewModel.class), new b(this), new c(this));
    ...
    public final class a extends RecyclerAdapter<String, ItemGroupManageBinding> {
        ...
        public final /* synthetic */ GroupManageDialog f7320f;
        ...
        public void w(final ItemViewHolder itemViewHolder, ViewBinding viewBinding) {
            ...
            j.e(itemViewHolder, "holder");
            j.e(itemGroupManageBinding, "binding");
            final GroupManageDialog groupManageDialog = this.f7320f;
            itemGroupManageBinding.f6793c.setOnClickListener(new View.OnClickListener() { // from class: e.a.a.g.d.l.c.r
                ...
                public final void onClick(View view) {
                    ...
                    a1 a1Var = new a1(groupManageDialog2, item);
                    ...
                    c.b.a.m.f.J4(((e.a.a.e.a.i) c.b.a.m.f.g0(fragmentActivityRequireActivity, string, null, a1Var)).p());
                }
            });
            itemGroupManageBinding.f6792b.setOnClickListener(new View.OnClickListener() { // from class: e.a.a.g.d.l.c.q
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    GroupManageDialog.a aVar = this.a;
                    ItemViewHolder itemViewHolder2 = itemViewHolder;
                    ...
                    BookSourceViewModel bookSourceViewModel = (BookSourceViewModel) groupManageDialog2.viewModel.getValue();
                    Objects.requireNonNull(bookSourceViewModel);
                    f.c0.c.j.e(item, "group");
                    BaseViewModel.a(bookSourceViewModel, null, null, new f0(bookSourceViewModel, item, null), 3, null);
                }
            });
        }
    }
    ...
    public static final BookSourceViewModel N(GroupManageDialog groupManageDialog) {
        return (BookSourceViewModel) groupManageDialog.viewModel.getValue();
    }

    public final DialogRecyclerViewBinding O() {
        return (DialogRecyclerViewBinding) this.binding.b(this, a[1]);
    }
    ...
    public boolean onMenuItemClick(@Nullable MenuItem item) {
        ...
        j.d(fragmentActivityRequireActivity, "requireActivity()");
        f.J4(((i) f.g0(fragmentActivityRequireActivity, string, null, z0Var)).p());
        return true;
    }
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle savedInstanceState) {
        ...
        O().f6672c.setBackgroundColor(f.Q2(this));
        O().f6672c.setTitle(getString(R.string.group_manage));
        O().f6672c.inflateMenu(R.menu.group_manage);
        Menu menu = O().f6672c.getMenu();
        j.d(menu, "binding.toolBar.menu");
        Context contextRequireContext = requireContext();
        j.d(contextRequireContext, "requireContext()");
        m.b(menu, contextRequireContext, null, 2);
        O().f6672c.setOnMenuItemClickListener(this);
        Context contextRequireContext2 = requireContext();
        j.d(contextRequireContext2, "requireContext()");
        this.adapter = new a(this, contextRequireContext2);
        O().f6671b.setLayoutManager(new LinearLayoutManager(requireContext()));
        FastScrollRecyclerView fastScrollRecyclerView = O().f6671b;
        ...
        FastScrollRecyclerView fastScrollRecyclerView2 = O().f6671b;
        a aVar = this.adapter;
        if (aVar == null) {
            j.m("adapter");
            throw null;
        ...
        AppDatabaseKt.getAppDb().getBookSourceDao().liveGroup().observe(getViewLifecycleOwner(), new Observer() { // from class: e.a.a.g.d.l.c.s
