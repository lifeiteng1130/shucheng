...
public final class j {
    ...
    public static final j[] f1312b = a();
    ...
    public int c() {
        return (this.f1313c * 4) + 17;
    }

    public String toString() {
        return String.valueOf(this.f1313c);
    }
}
