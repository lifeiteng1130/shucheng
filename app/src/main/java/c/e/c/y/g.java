...
public final class g {
    ...
    public final List<String> f1459b = new ArrayList();
    ...
    public final synchronized void b() {
        if (this.a.isEmpty()) {
            ...
            a(new int[]{30, 39}, "US");
            a(new int[]{60, Token.USE_STACK}, "US/CA");
            a(new int[]{300, 379}, "FR");
            a(new int[]{380}, "BG");
            a(new int[]{383}, "SI");
            a(new int[]{385}, "HR");
            a(new int[]{387}, "BA");
            a(new int[]{TinkerReport.KEY_LOADED_SUCC_COST_500_LESS, 440}, "DE");
            ...
            a(new int[]{Camera2CameraImpl.StateCallback.REOPEN_DELAY_MS, 709}, "NO");
            a(new int[]{729}, "IL");
