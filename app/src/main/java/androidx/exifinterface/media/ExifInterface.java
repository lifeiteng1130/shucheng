...
public class ExifInterface {
    ...
    private static final byte[] PNG_SIGNATURE = {-119, 80, 78, 71, bw.f4789k, 10, 26, 10};
    ...
    public static class ExifAttribute {
        ...
        public String toString() {
            ...
            sbR.append(ExifInterface.IFD_FORMAT_NAMES[this.format]);
            sbR.append(", data length:");
            return a.o(sbR, this.bytes.length, ")");
        }
    ...
    public static class Rational {
        ...
        public String toString() {
            return this.numerator + w.DEFAULT_PATH_SEPARATOR + this.denominator;
        }
    ...
    static {
        ...
        ExifTag[] exifTagArr5 = {new ExifTag(TAG_NEW_SUBFILE_TYPE, TinkerReport.KEY_LOADED_EXCEPTION_RESOURCE, 4), new ExifTag(TAG_SUBFILE_TYPE, 255, 4), new ExifTag(TAG_THUMBNAIL_IMAGE_WIDTH, 256, 3, 4), new ExifTag(TAG_THUMBNAIL_IMAGE_LENGTH, 257, 3, 4), new ExifTag(TAG_BITS_PER_SAMPLE, 258, 3), new ExifTag(TAG_COMPRESSION, 259, 3), new ExifTag(TAG_PHOTOMETRIC_INTERPRETATION, 262, 3), new ExifTag(TAG_IMAGE_DESCRIPTION, 270, 2), new ExifTag(TAG_MAKE, 271, 2), new ExifTag(TAG_MODEL, 272, 2), new ExifTag(TAG_STRIP_OFFSETS, 273, 3, 4), new ExifTag(TAG_THUMBNAIL_ORIENTATION, 274, 3), new ExifTag(TAG_SAMPLES_PER_PIXEL, 277, 3), new ExifTag(TAG_ROWS_PER_STRIP, 278, 3, 4), new ExifTag(TAG_STRIP_BYTE_COUNTS, 279, 3, 4), new ExifTag(TAG_X_RESOLUTION, 282, 5), new ExifTag(TAG_Y_RESOLUTION, 283, 5), new ExifTag(TAG_PLANAR_CONFIGURATION, 284, 3), new ExifTag(TAG_RESOLUTION_UNIT, 296, 3), new ExifTag(TAG_TRANSFER_FUNCTION, 301, 3), new ExifTag(TAG_SOFTWARE, 305, 2), new ExifTag(TAG_DATETIME, TinkerReport.KEY_LOADED_MISSING_PATCH_INFO, 2), new ExifTag(TAG_ARTIST, 315, 2), new ExifTag(TAG_WHITE_POINT, 318, 5), new ExifTag(TAG_PRIMARY_CHROMATICITIES, 319, 5), new ExifTag("SubIFDPointer", 330, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT, InputDeviceCompat.SOURCE_DPAD, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, 514, 4), new ExifTag(TAG_Y_CB_CR_COEFFICIENTS, 529, 5), new ExifTag(TAG_Y_CB_CR_SUB_SAMPLING, 530, 3), new ExifTag(TAG_Y_CB_CR_POSITIONING, 531, 3), new ExifTag(TAG_REFERENCE_BLACK_WHITE, 532, 5), new ExifTag(TAG_COPYRIGHT, 33432, 2), new ExifTag("ExifIFDPointer", 34665, 4), new ExifTag("GPSInfoIFDPointer", 34853, 4), new ExifTag(TAG_DNG_VERSION, 50706, 1), new ExifTag(TAG_DEFAULT_CROP_SIZE, 50720, 3, 4)};
    ...
    private static double convertRationalLatLonToDouble(String str, String str2) {
        try {
            ...
            String[] strArrSplit2 = strArrSplit[0].split(w.DEFAULT_PATH_SEPARATOR, -1);
            double d2 = Double.parseDouble(strArrSplit2[0].trim()) / Double.parseDouble(strArrSplit2[1].trim());
            String[] strArrSplit3 = strArrSplit[1].split(w.DEFAULT_PATH_SEPARATOR, -1);
            double d3 = Double.parseDouble(strArrSplit3[0].trim()) / Double.parseDouble(strArrSplit3[1].trim());
            String[] strArrSplit4 = strArrSplit[2].split(w.DEFAULT_PATH_SEPARATOR, -1);
    ...
    private void copyChunksUpToGivenChunkType(ByteOrderedDataInputStream byteOrderedDataInputStream, ByteOrderedDataOutputStream byteOrderedDataOutputStream, byte[] bArr, byte[] bArr2) throws IOException {
        ...
        while (true) {
            ...
            if (byteOrderedDataInputStream.read(bArr3) != 4) {
                StringBuilder sbR = a.r("Encountered invalid length while copying WebP chunks up tochunk type ");
                Charset charset = ASCII;
                sbR.append(new String(bArr, charset));
                if (bArr2 == null) {
                    string = "";
                } else {
                    StringBuilder sbR2 = a.r(" or ");
                    sbR2.append(new String(bArr2, charset));
    ...
    */
    ...
    private void parseTiffHeaders(ByteOrderedDataInputStream byteOrderedDataInputStream, int i2) throws IOException {
        ...
        if (i3 != 7 && i3 != 10 && unsignedShort != 42) {
            StringBuilder sbR = a.r("Invalid start code: ");
            sbR.append(Integer.toHexString(unsignedShort));
            throw new IOException(sbR.toString());
        }
        int i4 = byteOrderedDataInputStream.readInt();
        if (i4 < 8 || i4 >= i2) {
            throw new IOException(a.G("Invalid first Ifd offset: ", i4));
        }
        int i5 = i4 - 8;
        if (i5 > 0 && byteOrderedDataInputStream.skipBytes(i5) != i5) {
            throw new IOException(a.G("Couldn't jump to first Ifd: ", i5));
        }
    }
    ...
    private ByteOrder readByteOrder(ByteOrderedDataInputStream byteOrderedDataInputStream) throws IOException {
        ...
        StringBuilder sbR = a.r("Invalid byte order: ");
        sbR.append(Integer.toHexString(s));
        throw new IOException(sbR.toString());
    }
    ...
    private int writeExifSegment(ByteOrderedDataOutputStream byteOrderedDataOutputStream) throws IOException {
        ...
        for (int i5 = 0; i5 < EXIF_TAGS.length; i5++) {
            if (!this.mAttributes[i5].isEmpty()) {
                iArr[i5] = size2;
                size2 = (this.mAttributes[i5].size() * 12) + 2 + 4 + iArr2[i5] + size2;
            }
        }
        if (this.mHasThumbnail) {
        ...
        for (int i8 = 0; i8 < EXIF_TAGS.length; i8++) {
            if (!this.mAttributes[i8].isEmpty()) {
                ...
                int size3 = (this.mAttributes[i8].size() * 12) + iArr[i8] + 2 + 4;
    ...
    */
    public byte[] getThumbnailBytes() throws java.lang.Throwable {
        ...
        L6:
            ...
            return r0
        Lb:
            android.content.res.AssetManager$AssetInputStream r0 = r10.mAssetInputStream     // Catch: java.lang.Throwable -> L95 java.lang.Exception -> La1
            if (r0 == 0) goto L28
        ...
        L25:
            ...
            goto La3
        L28:
            java.lang.String r0 = r10.mFilename     // Catch: java.lang.Throwable -> L95 java.lang.Exception -> La1
            if (r0 == 0) goto L34
            java.io.FileInputStream r0 = new java.io.FileInputStream     // Catch: java.lang.Throwable -> L95 java.lang.Exception -> La1
            java.lang.String r2 = r10.mFilename     // Catch: java.lang.Throwable -> L95 java.lang.Exception -> La1
            r0.<init>(r2)     // Catch: java.lang.Throwable -> L95 java.lang.Exception -> La1
            goto L18
        L34:
            java.io.FileDescriptor r0 = r10.mSeekableFileDescriptor     // Catch: java.lang.Throwable -> L95 java.lang.Exception -> La1
            if (r0 == 0) goto L53
            java.io.FileDescriptor r0 = android.system.Os.dup(r0)     // Catch: java.lang.Throwable -> L95 java.lang.Exception -> La1
            r2 = 0
            int r4 = android.system.OsConstants.SEEK_SET     // Catch: java.lang.Throwable -> L4c java.lang.Exception -> L50
            android.system.Os.lseek(r0, r2, r4)     // Catch: java.lang.Throwable -> L4c java.lang.Exception -> L50
        ...
        L55:
            if (r0 == 0) goto L8f
            int r3 = r10.mThumbnailOffset     // Catch: java.lang.Throwable -> L8a java.lang.Exception -> La3
            ...
            int r5 = r10.mThumbnailOffset     // Catch: java.lang.Throwable -> L8a java.lang.Exception -> La3
            long r5 = (long) r5
            java.lang.String r7 = "Corrupted image"
            int r8 = (r3 > r5 ? 1 : (r3 == r5 ? 0 : -1))
            if (r8 != 0) goto L84
            int r3 = r10.mThumbnailLength     // Catch: java.lang.Throwable -> L8a java.lang.Exception -> La3
            byte[] r3 = new byte[r3]     // Catch: java.lang.Throwable -> L8a java.lang.Exception -> La3
            int r4 = r0.read(r3)     // Catch: java.lang.Throwable -> L8a java.lang.Exception -> La3
            int r5 = r10.mThumbnailLength     // Catch: java.lang.Throwable -> L8a java.lang.Exception -> La3
            if (r4 != r5) goto L7e
            r10.mThumbnailBytes = r3     // Catch: java.lang.Throwable -> L8a java.lang.Exception -> La3
            closeQuietly(r0)
            if (r2 == 0) goto L7d
        ...
        L7e:
            ...
            r3.<init>(r7)     // Catch: java.lang.Throwable -> L8a java.lang.Exception -> La3
    ...
    */
    ...
    public void setAltitude(double d2) {
        String str = d2 >= 0.0d ? "0" : SdkVersion.MINI_VERSION;
            ...
            if ((i6 != 4 || this.mHasThumbnail) && (exifTag = sExifTagMapsForWriting[i6].get(str3)) != null) {
                if (string != null) {
                        ...
                        if (i7 == -1 || !(i7 == ((Integer) pairGuessDataFormat.first).intValue() || exifTag.secondaryFormat == ((Integer) pairGuessDataFormat.second).intValue())) {
                            ...
                            if (i8 == i5 || i8 == 7 || i8 == i4) {
                                ...
                                if (exifTag.secondaryFormat != -1) {
                                    StringBuilder sbR = a.r(", ");
                                    sbR.append(strArr[exifTag.secondaryFormat]);
                                    sbR.toString();
                                }
                                ...
                                if (((Integer) pairGuessDataFormat.second).intValue() != -1) {
                                    ...
                                    sbR2.append(strArr[((Integer) pairGuessDataFormat.second).intValue()]);
                                    sbR2.toString();
                                }
                            }
                        } else {
                    ...
                    switch (i2) {
                        case 1:
                            i3 = i6;
                            this.mAttributes[i3].put(str3, ExifAttribute.createByte(string));
                            break;
                        case 2:
                        case 7:
                            i3 = i6;
                            this.mAttributes[i3].put(str3, ExifAttribute.createString(string));
                            break;
                        case 3:
                            i3 = i6;
                        ...
                        case 5:
                            ...
                            for (int i11 = 0; i11 < strArrSplit3.length; i11++) {
                                String[] strArrSplit4 = strArrSplit3[i11].split(w.DEFAULT_PATH_SEPARATOR, -1);
                        ...
                        case 10:
                            ...
                            while (i13 < strArrSplit6.length) {
                                String[] strArrSplit7 = strArrSplit6[i13].split(w.DEFAULT_PATH_SEPARATOR, -1);
                                rationalArr2[i13] = new Rational((long) Double.parseDouble(strArrSplit7[c2]), (long) Double.parseDouble(strArrSplit7[i5]));
                                i13++;
                                i5 = 1;
                                i6 = i6;
                                c2 = 0;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private ExifInterface(@androidx.annotation.NonNull java.io.InputStream r3, boolean r4) throws java.lang.Throwable {
        /*
            r2 = this;
            r2.<init>()
