...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public static class Result<T> {
        ...
        public void detach() {
            if (this.mDetachCalled) {
                StringBuilder sbR = a.r("detach() called when detach() had already been called for: ");
                sbR.append(this.mDebug);
                throw new IllegalStateException(sbR.toString());
            }
            if (this.mSendResultCalled) {
                StringBuilder sbR2 = a.r("detach() called when sendResult() had already been called for: ");
                sbR2.append(this.mDebug);
                throw new IllegalStateException(sbR2.toString());
            }
            if (!this.mSendErrorCalled) {
                this.mDetachCalled = true;
            } else {
                StringBuilder sbR3 = a.r("detach() called when sendError() had already been called for: ");
                sbR3.append(this.mDebug);
        ...
        public void onErrorSent(Bundle bundle) {
            StringBuilder sbR = a.r("It is not supported to send an error for ");
            sbR.append(this.mDebug);
            throw new UnsupportedOperationException(sbR.toString());
        }

        public void onProgressUpdateSent(Bundle bundle) {
            StringBuilder sbR = a.r("It is not supported to send an interim update for ");
            sbR.append(this.mDebug);
            throw new UnsupportedOperationException(sbR.toString());
        }
        ...
        public void sendError(Bundle bundle) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder sbR = a.r("sendError() called when either sendResult() or sendError() had already been called for: ");
                sbR.append(this.mDebug);
                throw new IllegalStateException(sbR.toString());
            }
        ...
        public void sendProgressUpdate(Bundle bundle) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder sbR = a.r("sendProgressUpdate() called when either sendResult() or sendError() had already been called for: ");
                sbR.append(this.mDebug);
                throw new IllegalStateException(sbR.toString());
            }
        ...
        public void sendResult(T t) {
            if (this.mSendResultCalled || this.mSendErrorCalled) {
                StringBuilder sbR = a.r("sendResult() called when either sendResult() or sendError() had already been called for: ");
                sbR.append(this.mDebug);
                throw new IllegalStateException(sbR.toString());
            }
        ...
        public void sendCustomAction(final String str, final Bundle bundle, final ResultReceiver resultReceiver, final ServiceCallbacks serviceCallbacks) {
            ...
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.9
                ...
                public void run() {
                    ...
                    StringBuilder sbR = a.r("sendCustomAction for callback that isn't registered action=");
                    sbR.append(str);
                    sbR.append(", extras=");
                    sbR.append(bundle);
                    sbR.toString();
    ...
    public void performLoadChildren(final String str, final ConnectionRecord connectionRecord, final Bundle bundle, final Bundle bundle2) {
        ...
        StringBuilder sbR = a.r("onLoadChildren must call detach() or sendResult() before returning for package=");
        sbR.append(connectionRecord.pkg);
        sbR.append(" id=");
        sbR.append(str);
        throw new IllegalStateException(sbR.toString());
    }
    ...
    public void performLoadItem(String str, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(a.i("onLoadItem must call detach() or sendResult() before returning for id=", str));
        }
    }
    ...
    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final ResultReceiver resultReceiver) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(a.i("onSearch must call detach() or sendResult() before returning for query=", str));
        }
    }
