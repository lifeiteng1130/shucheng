...
public class SessionResult extends CustomVersionedParcelable implements RemoteResult {
    ...
    public static a<SessionResult> createFutureWithResult(int i2) {
        ResolvableFuture resolvableFutureCreate = ResolvableFuture.create();
        resolvableFutureCreate.set(new SessionResult(i2));
    ...
    public SessionResult(int i2, @Nullable Bundle bundle, @Nullable MediaItem mediaItem, long j2) {
        this.mResultCode = i2;
