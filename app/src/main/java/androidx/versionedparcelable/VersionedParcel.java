...
public abstract class VersionedParcel {
    ...
    public Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException(a.k("VersionedParcelable encountered IOException reading a Serializable object (name = ", string, ")"), e2);
        } catch (ClassNotFoundException e3) {
            throw new RuntimeException(a.k("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = ", string, ")"), e3);
        }
    }
