        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    throw new RuntimeException(a.i("Failed to instantiate ", str), e2);
                }
            } catch (NoSuchMethodException e3) {
                StringBuilder sbR = a.r("Class");
                sbR.append(clsAsSubclass.getSimpleName());
                sbR.append(" must have default constructor in order to be automatically recreated");
                throw new IllegalStateException(sbR.toString(), e3);
            }
        } catch (ClassNotFoundException e4) {
            throw new RuntimeException(a.k("Class ", str, " wasn't found"), e4);
        }
    }
