...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            StringBuilder sbR = a.r("SearchView.SavedState{");
            sbR.append(Integer.toHexString(System.identityHashCode(this)));
            sbR.append(" isIconified=");
            sbR.append(this.isIconified);
            sbR.append("}");
            return sbR.toString();
        }
    ...
    private Intent createIntent(String str, Uri uri, String str2, String str3, int i2, String str4) {
        ...
        if (str3 != null) {
            intent.putExtra(MediaConstants.MEDIA_URI_QUERY_QUERY, str3);
        }
        if (str2 != null) {
        ...
        try {
            try {
                ...
                if (columnString3 != null && (columnString = SuggestionsAdapter.getColumnString(cursor, "suggest_intent_data_id")) != null) {
                    columnString3 = columnString3 + w.DEFAULT_PATH_SEPARATOR + Uri.encode(columnString);
                }
