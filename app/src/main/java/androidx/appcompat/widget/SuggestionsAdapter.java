...
public class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            String str2 = "android.resource://" + this.mProviderContext.getPackageName() + w.DEFAULT_PATH_SEPARATOR + i2;
    ...
    public Drawable getDrawableFromResourceUri(Uri uri) throws FileNotFoundException {
        ...
        if (TextUtils.isEmpty(authority)) {
            throw new FileNotFoundException(a.g("No authority: ", uri));
        }
        try {
            Resources resourcesForApplication = this.mContext.getPackageManager().getResourcesForApplication(authority);
            List<String> pathSegments = uri.getPathSegments();
            if (pathSegments == null) {
                throw new FileNotFoundException(a.g("No path: ", uri));
            }
            ...
            if (size == 1) {
                try {
                    ...
                    throw new FileNotFoundException(a.g("Single path segment is not a resource ID: ", uri));
                }
            } else {
                if (size != 2) {
                    throw new FileNotFoundException(a.g("More than two path segments: ", uri));
                }
            ...
            throw new FileNotFoundException(a.g("No resource found for: ", uri));
        } catch (PackageManager.NameNotFoundException unused2) {
            throw new FileNotFoundException(a.g("No package found for authority: ", uri));
        }
    }
