...
public class AppCompatTextViewAutoSizeHelper {
    ...
    private static Field getTextViewField(@NonNull String str) {
        try {
            Field declaredField = (Field) sTextViewFieldByNameCache.get(str);
    ...
    public StaticLayout createLayout(CharSequence charSequence, Layout.Alignment alignment, int i2, int i3) {
        return Build.VERSION.SDK_INT >= 23 ? createStaticLayoutForMeasuring(charSequence, alignment, i2, i3) : createStaticLayoutForMeasuringPre23(charSequence, alignment, i2);
    }
        ...
        if (supportsAutoSizeText()) {
            ...
            if (length > 0) {
                ...
                if (!setupAutoSizeUniformPresetSizesConfiguration()) {
                    StringBuilder sbR = a.r("None of the preset sizes is valid: ");
    ...
    public void setAutoSizeTextTypeWithDefaults(int i2) {
        if (supportsAutoSizeText()) {
            ...
            if (i2 != 1) {
                throw new IllegalArgumentException(a.G("Unknown auto-size text type: ", i2));
            }
            DisplayMetrics displayMetrics = this.mContext.getResources().getDisplayMetrics();
