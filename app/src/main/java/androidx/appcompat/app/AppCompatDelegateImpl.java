...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private ViewGroup createSubDecor() {
        ...
        if (viewGroup == null) {
            StringBuilder sbR = a.r("AppCompat does not support the current theme features: { windowActionBar: ");
            sbR.append(this.mHasActionBar);
            sbR.append(", windowActionBarOverlay: ");
            sbR.append(this.mOverlayActionBar);
            sbR.append(", android:windowIsFloating: ");
            sbR.append(this.mIsFloating);
            sbR.append(", windowActionModeOverlay: ");
            sbR.append(this.mOverlayActionMode);
            sbR.append(", windowNoTitle: ");
            sbR.append(this.mWindowNoTitle);
            sbR.append(" }");
