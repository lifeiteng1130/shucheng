...
public final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private int getNextMenuPosition(int i2) {
        ListView listView = ((CascadingMenuInfo) a.E(this.mShowingMenus, 1)).getListView();
        int[] iArr = new int[2];
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (this.mShowingMenus.size() > 0) {
            cascadingMenuInfo = (CascadingMenuInfo) a.E(this.mShowingMenus, 1);
        ...
        if (viewFindParentViewForSubmenu != null) {
            ...
            if ((this.mDropDownGravity & 5) != 5) {
                width = z ? i3 + viewFindParentViewForSubmenu.getWidth() : i3 - iMeasureIndividualMenuWidth;
