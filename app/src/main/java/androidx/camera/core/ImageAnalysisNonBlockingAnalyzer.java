...
public final class ImageAnalysisNonBlockingAnalyzer extends ImageAnalysisAbstractAnalyzer {
    ...
    public static class CacheAnalyzingImageProxy extends ForwardingImageProxy {
        ...
        public CacheAnalyzingImageProxy(ImageProxy imageProxy, ImageAnalysisNonBlockingAnalyzer imageAnalysisNonBlockingAnalyzer) {
            ...
            addOnImageCloseListener(new ForwardingImageProxy.OnImageCloseListener() { // from class: b.a.b.t
                @Override // androidx.camera.core.ForwardingImageProxy.OnImageCloseListener
                public final void onImageClose(ImageProxy imageProxy2) {
                    final ImageAnalysisNonBlockingAnalyzer imageAnalysisNonBlockingAnalyzer2 = this.a.mNonBlockingAnalyzerWeakReference.get();
                    if (imageAnalysisNonBlockingAnalyzer2 != null) {
                        imageAnalysisNonBlockingAnalyzer2.mBackgroundExecutor.execute(new Runnable() { // from class: b.a.b.v1
                            @Override // java.lang.Runnable
                            public final void run() {
                                imageAnalysisNonBlockingAnalyzer2.analyzeCachedImage();
                            }
                        });
                    }
                }
