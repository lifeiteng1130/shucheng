...
public final class AutoValue_ImageReaderFormatRecommender_FormatCombo extends ImageReaderFormatRecommender.FormatCombo {
    ...
    public String toString() {
        StringBuilder sbR = a.r("FormatCombo{imageCaptureFormat=");
        sbR.append(this.imageCaptureFormat);
        sbR.append(", imageAnalysisFormat=");
        return a.o(sbR, this.imageAnalysisFormat, "}");
    }
}
