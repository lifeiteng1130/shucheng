...
public final class AutoValue_OutputFileOptions extends OutputFileOptions {
    ...
    public String toString() {
        StringBuilder sbR = a.r("OutputFileOptions{file=");
        sbR.append(this.file);
        sbR.append(", fileDescriptor=");
        sbR.append(this.fileDescriptor);
        sbR.append(", contentResolver=");
        sbR.append(this.contentResolver);
        sbR.append(", saveCollection=");
        sbR.append(this.saveCollection);
        sbR.append(", contentValues=");
        sbR.append(this.contentValues);
        sbR.append(", metadata=");
        sbR.append(this.metadata);
        sbR.append("}");
        return sbR.toString();
    }
