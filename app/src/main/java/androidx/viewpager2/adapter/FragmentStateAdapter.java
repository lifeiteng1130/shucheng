    ...
    public void placeFragmentInViewHolder(@NonNull final FragmentViewHolder fragmentViewHolder) {
        ...
        if (fragment.isAdded() && view.getParent() != null) {
            ...
            if (shouldDelayFragmentTransactions()) {
                ...
                StringBuilder sbR = a.r("f");
                sbR.append(fragmentViewHolder.getItemId());
                fragmentTransactionBeginTransaction.add(fragment, sbR.toString()).setMaxLifecycle(fragment, Lifecycle.State.STARTED).commitNow();
