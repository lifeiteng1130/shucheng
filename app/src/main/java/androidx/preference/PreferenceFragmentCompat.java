...
public abstract class PreferenceFragmentCompat extends Fragment implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, DialogPreference.TargetFragment {
    ...
    public void addPreferencesFromResource(@XmlRes int i2) {
        ...
        setPreferenceScreen(this.mPreferenceManager.inflateFromResource(getContext(), i2, getPreferenceScreen()));
    }
        ...
        if (!zOnPreferenceDisplayDialog && getParentFragmentManager().findFragmentByTag(DIALOG_FRAGMENT_TAG) == null) {
            if (preference instanceof EditTextPreference) {
                ...
                if (!(preference instanceof MultiSelectListPreference)) {
                    ...
                    sbR.append(preference.getClass().getSimpleName());
    ...
    public void setPreferencesFromResource(@XmlRes int i2, @Nullable String str) {
        requirePreferenceManager();
        PreferenceScreen preferenceScreenInflateFromResource = this.mPreferenceManager.inflateFromResource(getContext(), i2, null);
        ...
        if (str != null) {
            ...
            if (!z) {
                throw new IllegalArgumentException(a.k("Preference object with key ", str, " is not a PreferenceScreen"));
            }
        }
