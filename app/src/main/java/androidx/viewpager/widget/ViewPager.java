...
public class ViewPager extends ViewGroup {
    ...
    public static class AnonymousClass1 implements Comparator<ItemInfo>, j$.util.Comparator {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            StringBuilder sbR = a.r("FragmentPager.SavedState{");
            sbR.append(Integer.toHexString(System.identityHashCode(this)));
            sbR.append(" position=");
            return a.o(sbR, this.position, "}");
        }
    ...
    public static class ViewPositionComparator implements java.util.Comparator<View>, j$.util.Comparator {
        @Override // java.util.Comparator, j$.util.Comparator
  ...
  0x00f3: PHI (r12v5 float) = (r12v3 float), (r12v4 float), (r12v2 float) binds: [B:62:0x00e8, B:59:0x00d2, B:53:0x00bc] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public void smoothScrollTo(int i2, int i3, int i4) {
        ...
        int iMin = Math.min(iAbs > 0 ? Math.round(Math.abs(fDistanceInfluenceForSnapDuration / iAbs) * 1000.0f) * 4 : (int) (((Math.abs(i6) / ((this.mAdapter.getPageWidth(this.mCurItem) * f2) + this.mPageMargin)) + 1.0f) * 100.0f), MAX_SETTLE_DURATION);
