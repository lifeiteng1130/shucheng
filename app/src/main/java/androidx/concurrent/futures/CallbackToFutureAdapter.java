...
public final class CallbackToFutureAdapter {
    ...
    public static final class Completer<T> {
        ...
        public void finalize() {
            ...
            if (safeFuture != null && !safeFuture.isDone()) {
                StringBuilder sbR = a.r("The completer object was garbage collected - this future would otherwise never complete. The tag was: ");
                sbR.append(this.tag);
                safeFuture.setException(new FutureGarbageCollectedException(sbR.toString()));
            }
    ...
    public static final class SafeFuture<T> implements c.e.b.a.a.a<T> {
        ...
        private final AbstractResolvableFuture<T> delegate = new AbstractResolvableFuture<T>() { // from class: androidx.concurrent.futures.CallbackToFutureAdapter.SafeFuture.1
            ...
            public String pendingToString() {
                ...
                StringBuilder sbR = a.r("tag=[");
                sbR.append(completer.tag);
                sbR.append("]");
                return sbR.toString();
            }
        };
    ...
    @NonNull
    public static <T> c.e.b.a.a.a<T> getFuture(@NonNull Resolver<T> resolver) {
