...
public abstract class AbstractResolvableFuture<V> implements a<V> {
    ...
    public final V get(long j2, TimeUnit timeUnit) throws InterruptedException, TimeoutException {
        ...
        String strI = "Waited " + j2 + " " + timeUnit.toString().toLowerCase(locale);
        if (nanos + 1000 < 0) {
            String strI2 = c.a.a.a.a.i(strI, " (plus ");
            long j3 = -nanos;
            ...
            if (jConvert > 0) {
                ...
                if (z) {
                    strI3 = c.a.a.a.a.i(strI3, ",");
                }
                strI2 = c.a.a.a.a.i(strI3, " ");
            }
            if (z) {
                strI2 = strI2 + nanos2 + " nanoseconds ";
            }
            strI = c.a.a.a.a.i(strI2, "delay)");
        }
        if (isDone()) {
            throw new TimeoutException(c.a.a.a.a.i(strI, " but future completed as timeout expired"));
        }
        throw new TimeoutException(c.a.a.a.a.k(strI, " for ", string));
    }
    ...
    public String pendingToString() {
        Object obj = this.value;
        if (obj instanceof SetFuture) {
            return c.a.a.a.a.p(c.a.a.a.a.r("setFuture=["), userObjectToString(((SetFuture) obj).future), "]");
        }
        if (!(this instanceof ScheduledFuture)) {
            return null;
        }
        StringBuilder sbR = c.a.a.a.a.r("remaining delay=[");
        sbR.append(((ScheduledFuture) this).getDelay(TimeUnit.MILLISECONDS));
        sbR.append(" ms]");
        return sbR.toString();
    }
    ...
    public String toString() {
        ...
        if (isCancelled()) {
            ...
            try {
                ...
                StringBuilder sbR = c.a.a.a.a.r("Exception thrown from implementation: ");
                sbR.append(e2.getClass());
                string = sbR.toString();
            }
