...
public class FrameworkSQLiteDatabase implements SupportSQLiteDatabase {
    ...
    public int delete(String str, String str2, Object[] objArr) {
        StringBuilder sbT = a.t("DELETE FROM ", str);
        sbT.append(TextUtils.isEmpty(str2) ? "" : a.i(" WHERE ", str2));
        SupportSQLiteStatement supportSQLiteStatementCompileStatement = compileStatement(sbT.toString());
