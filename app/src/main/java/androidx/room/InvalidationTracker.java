...
public class InvalidationTracker {
    ...
    private void startTrackingTable(SupportSQLiteDatabase supportSQLiteDatabase, int i2) {
        ...
        for (String str2 : TRIGGERS) {
            ...
            a.z(sb, "` BEGIN UPDATE ", UPDATE_TABLE_NAME, " SET ", INVALIDATED_COLUMN_NAME);
            a.z(sb, " = 1", " WHERE ", TABLE_ID_COLUMN_NAME, " = ");
            sb.append(i2);
            sb.append(" AND ");
    ...
    private String[] validateAndResolveTableNames(String[] strArr) {
        ...
        for (String str : strArrResolveViews) {
            if (!this.mTableIdLookup.containsKey(str.toLowerCase(Locale.US))) {
                throw new IllegalArgumentException(a.i("There is no table with name ", str));
            }
        }
    ...
    public void addObserver(@NonNull Observer observer) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (num == null) {
                StringBuilder sbR = a.r("There is no table with name ");
                sbR.append(strArrResolveViews[i2]);
    ...
    public void setAutoCloser(AutoCloser autoCloser) {
        ...
        autoCloser.setAutoCloseCallback(new Runnable() { // from class: b.d.w0
