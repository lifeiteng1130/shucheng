...
public abstract class RoomDatabase {
    ...
    public void beginTransaction() {
        ...
        if (autoCloser == null) {
            ...
            autoCloser.executeRefCountingFunction(new Function() { // from class: b.d.p0
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    this.a.a((SupportSQLiteDatabase) obj);
                    return null;
                }
            });
        }
    ...
    public void endTransaction() {
        ...
        if (autoCloser == null) {
            ...
            autoCloser.executeRefCountingFunction(new Function() { // from class: b.d.q0
                @Override // androidx.arch.core.util.Function
                public final Object apply(Object obj) {
                    this.a.b((SupportSQLiteDatabase) obj);
                    return null;
                }
            });
        }
    ...
    public void init(@NonNull DatabaseConfiguration databaseConfiguration) {
        ...
        for (Map.Entry<Class<?>, List<Class<?>>> entry : requiredTypeConverters.entrySet()) {
            ...
            for (Class<?> cls : entry.getValue()) {
                ...
                this.mTypeConverters.put(cls, databaseConfiguration.typeConverters.get(size));
            }
        }
