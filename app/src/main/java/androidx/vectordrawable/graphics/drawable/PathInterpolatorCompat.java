...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        StringBuilder sbR = a.r("The Path must start at (0,0) and end at (1,1) start: ");
        sbR.append(this.mX[0]);
        sbR.append(",");
        sbR.append(this.mY[0]);
        sbR.append(" end:");
        int i7 = iMin - 1;
        sbR.append(this.mX[i7]);
        sbR.append(",");
        sbR.append(this.mY[i7]);
