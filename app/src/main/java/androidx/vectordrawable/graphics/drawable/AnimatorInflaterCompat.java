...
public class AnimatorInflaterCompat {
    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            StringBuilder sbS = a.s("Keyframe ", i2, ": fraction ");
            Object value = "null";
            sbS.append(keyframe.getFraction() < 0.0f ? "null" : Float.valueOf(keyframe.getFraction()));
            sbS.append(", , value : ");
    ...
    private static int inferValueTypeOfKeyframe(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        ...
        int i2 = 0;
        TypedValue typedValuePeekNamedValue = TypedArrayUtils.peekNamedValue(typedArrayObtainAttributes, xmlPullParser, ES6Iterator.VALUE_PROPERTY, 0);
    ...
    private static Keyframe loadKeyframe(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i2, XmlPullParser xmlPullParser) {
        ...
        Keyframe keyframeOfInt = z ? i2 != 0 ? (i2 == 1 || i2 == 3) ? Keyframe.ofInt(namedFloat, TypedArrayUtils.getNamedInt(typedArrayObtainAttributes, xmlPullParser, ES6Iterator.VALUE_PROPERTY, 0, 0)) : null : Keyframe.ofFloat(namedFloat, TypedArrayUtils.getNamedFloat(typedArrayObtainAttributes, xmlPullParser, ES6Iterator.VALUE_PROPERTY, 0, 0.0f)) : i2 == 0 ? Keyframe.ofFloat(namedFloat) : Keyframe.ofInt(namedFloat);
