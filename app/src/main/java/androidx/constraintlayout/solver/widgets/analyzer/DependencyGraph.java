...
public class DependencyGraph {
    ...
    private void displayGraph() {
        ...
        String strI = a.i(strGenerateDisplayGraph, "\n}\n");
    ...
    private String generateChainDisplayGraph(ChainRun chainRun, String str) {
        ...
        StringBuilder sbR = a.r("cluster_");
        sbR.append(chainRun.widget.getDebugName());
        String string = sbR.toString();
        String strK = a.k("subgraph ", i2 == 0 ? a.i(string, "_h") : a.i(string, "_v"), " {\n");
        String strGenerateDisplayGraph = "";
        for (WidgetRun widgetRun : chainRun.widgets) {
            String debugName = widgetRun.widget.getDebugName();
            strK = a.k(strK, i2 == 0 ? a.i(debugName, "_HORIZONTAL") : a.i(debugName, "_VERTICAL"), ";\n");
            strGenerateDisplayGraph = generateDisplayGraph(widgetRun, strGenerateDisplayGraph);
        }
        return a.k(str, strGenerateDisplayGraph, a.i(strK, "}\n"));
    }
    ...
    private String generateDisplayGraph(WidgetRun widgetRun, String str) {
        ...
        sbR.append(nodeDefinition(widgetRun));
        String string = sbR.toString();
        ...
        if ((widgetRun instanceof HorizontalWidgetRun) || (((z = widgetRun instanceof ChainRun)) && ((ChainRun) widgetRun).orientation == 0)) {
            ...
            if (horizontalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.FIXED || horizontalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
                if (!dependencyNode.targets.isEmpty() && dependencyNode2.targets.isEmpty()) {
                    ...
                    sbR2.append(dependencyNode2.name());
                    sbR2.append(" -> ");
                    sbR2.append(dependencyNode.name());
                    sbR2.append("\n");
                    strGenerateDisplayNode = a.i(strGenerateDisplayNode, sbR2.toString());
                } else if (dependencyNode.targets.isEmpty() && !dependencyNode2.targets.isEmpty()) {
                    StringBuilder sbR3 = a.r("\n");
                    sbR3.append(dependencyNode.name());
                    sbR3.append(" -> ");
                    sbR3.append(dependencyNode2.name());
                    sbR3.append("\n");
                    strGenerateDisplayNode = a.i(strGenerateDisplayNode, sbR3.toString());
                }
            ...
            if (verticalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.FIXED || verticalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
                if (!dependencyNode.targets.isEmpty() && dependencyNode2.targets.isEmpty()) {
                    ...
                    sbR4.append(dependencyNode2.name());
                    sbR4.append(" -> ");
                    sbR4.append(dependencyNode.name());
                    sbR4.append("\n");
                    strGenerateDisplayNode = a.i(strGenerateDisplayNode, sbR4.toString());
                } else if (dependencyNode.targets.isEmpty() && !dependencyNode2.targets.isEmpty()) {
                    StringBuilder sbR5 = a.r("\n");
                    sbR5.append(dependencyNode.name());
                    sbR5.append(" -> ");
                    sbR5.append(dependencyNode2.name());
                    sbR5.append("\n");
                    strGenerateDisplayNode = a.i(strGenerateDisplayNode, sbR5.toString());
                }
    ...
    private String generateDisplayNode(DependencyNode dependencyNode, boolean z, String str) {
        for (DependencyNode dependencyNode2 : dependencyNode.targets) {
            ...
            sbR.append(dependencyNode.name());
            StringBuilder sbT = a.t(sbR.toString(), " -> ");
            ...
            if (dependencyNode.margin > 0 || z || (dependencyNode.run instanceof HelperReferences)) {
                String strI = a.i(string, "[");
                if (dependencyNode.margin > 0) {
                    strI = a.o(a.t(strI, "label=\""), dependencyNode.margin, "\"");
                    if (z) {
                        strI = a.i(strI, ",");
                    }
                }
                if (z) {
                    strI = a.i(strI, " style=dashed ");
                }
                if (dependencyNode.run instanceof HelperReferences) {
                    strI = a.i(strI, " style=bold,color=gray ");
                }
                string = a.i(strI, "]");
            }
            str = a.i(str, a.i(string, "\n"));
        }
        return str;
    }
    ...
    private String nodeDefinition(WidgetRun widgetRun) {
        ...
        String strI3 = a.i(a.i(a.i(!z ? a.i(debugName, "_HORIZONTAL") : a.i(debugName, "_VERTICAL"), " [shape=none, label=<"), "<TABLE BORDER=\"0\" CELLSPACING=\"0\" CELLPADDING=\"2\">"), "  <TR>");
        if (z) {
            String strI4 = a.i(strI3, "    <TD ");
            if (widgetRun.start.resolved) {
                strI4 = a.i(strI4, " BGCOLOR=\"green\"");
            }
            strI = a.i(strI4, " PORT=\"TOP\" BORDER=\"1\">T</TD>");
        } else {
            String strI5 = a.i(strI3, "    <TD ");
            if (widgetRun.start.resolved) {
                strI5 = a.i(strI5, " BGCOLOR=\"green\"");
            }
            strI = a.i(strI5, " PORT=\"LEFT\" BORDER=\"1\">L</TD>");
        }
        String strI6 = a.i(strI, "    <TD BORDER=\"1\" ");
        boolean z2 = widgetRun.dimension.resolved;
        if (z2 && !widgetRun.widget.measured) {
            strI6 = a.i(strI6, " BGCOLOR=\"green\" ");
        } else if (z2 && widgetRun.widget.measured) {
            strI6 = a.i(strI6, " BGCOLOR=\"lightgray\" ");
        } else if (!z2 && widgetRun.widget.measured) {
            strI6 = a.i(strI6, " BGCOLOR=\"yellow\" ");
        }
        if (horizontalDimensionBehaviour == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
            strI6 = a.i(strI6, "style=\"dashed\"");
        }
        if (runGroup != null) {
            StringBuilder sbR = a.r(" [");
            sbR.append(runGroup.groupIndex + 1);
            sbR.append(w.DEFAULT_PATH_SEPARATOR);
            strO = a.o(sbR, RunGroup.index, "]");
        } else {
            strO = "";
        }
        String str = strI6 + ">" + debugName + strO + " </TD>";
        if (z) {
            String strI7 = a.i(str, "    <TD ");
            if ((widgetRun instanceof VerticalWidgetRun) && ((VerticalWidgetRun) widgetRun).baseline.resolved) {
                strI7 = a.i(strI7, " BGCOLOR=\"green\"");
            }
            String strI8 = a.i(a.i(strI7, " PORT=\"BASELINE\" BORDER=\"1\">b</TD>"), "    <TD ");
            if (widgetRun.end.resolved) {
                strI8 = a.i(strI8, " BGCOLOR=\"green\"");
            }
            strI2 = a.i(strI8, " PORT=\"BOTTOM\" BORDER=\"1\">B</TD>");
        } else {
            String strI9 = a.i(str, "    <TD ");
            if (widgetRun.end.resolved) {
                strI9 = a.i(strI9, " BGCOLOR=\"green\"");
            }
            strI2 = a.i(strI9, " PORT=\"RIGHT\" BORDER=\"1\">R</TD>");
        }
        return a.i(a.i(strI2, "  </TR></TABLE>"), ">];\n");
    }
