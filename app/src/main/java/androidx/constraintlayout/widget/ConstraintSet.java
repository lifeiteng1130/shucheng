        ...
        for (int i2 = 0; i2 < strArr.length; i2++) {
            if (this.mSavedAttributes.containsKey(strArr[i2])) {
                ...
                if (constraintAttribute.getType() != attributeType) {
                    StringBuilder sbR = a.r("ConstraintAttribute is already a ");
                    sbR.append(constraintAttribute.getType().name());
                    throw new IllegalArgumentException(sbR.toString());
                }
            } else {
        ...
        switch (i3) {
            case 1:
                if (i5 == 1) {
                    ...
                    if (i5 != 2) {
                        throw new IllegalArgumentException(a.p(a.r("Left to "), sideToString(i5), " undefined"));
                    }
                    Layout layout2 = constraint.layout;
            ...
            case 2:
                if (i5 == 1) {
                    ...
                    if (i5 != 2) {
                        throw new IllegalArgumentException(a.p(a.r("right to "), sideToString(i5), " undefined"));
                    }
                    Layout layout4 = constraint.layout;
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(a.p(sb, sideToString(i5), " unknown"));
        }
    }
