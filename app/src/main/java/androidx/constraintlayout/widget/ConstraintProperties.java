        ...
        switch (i2) {
            case 1:
                if (i4 == 1) {
                    ...
                    if (i4 != 2) {
                        throw new IllegalArgumentException(a.p(a.r("Left to "), sideToString(i4), " undefined"));
                    }
            ...
            case 2:
                if (i4 == 1) {
                    ...
                    if (i4 != 2) {
                        throw new IllegalArgumentException(a.p(a.r("right to "), sideToString(i4), " undefined"));
                    }
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(a.p(sb, sideToString(i4), " unknown"));
        }
    }
