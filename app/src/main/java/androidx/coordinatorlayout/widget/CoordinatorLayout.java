...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public static class ViewElevationComparator implements Comparator<View>, j$.util.Comparator {
    ...
    private void getTopSortedChildren(List<View> list) {
        ...
        java.util.Comparator<View> comparator = TOP_SORTED_CHILDREN_COMPARATOR;
        if (comparator != null) {
    ...
    private void offsetChildByInset(View view, Rect rect, int i2) {
        ...
        if (ViewCompat.isLaidOut(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            if (behavior == null || !behavior.getInsetDodgeRect(this, view, rectAcquireTempRect)) {
                ...
                StringBuilder sbR = a.r("Rect should be within the child's bounds. Rect:");
                sbR.append(rectAcquireTempRect.toShortString());
                sbR.append(" | Bounds:");
                sbR.append(rectAcquireTempRect2.toShortString());
    ...
    public static Behavior parseBehavior(Context context, AttributeSet attributeSet, String str) {
        ...
        try {
            ...
            throw new RuntimeException(a.i("Could not inflate Behavior subclass ", str), e2);
        }
    }
        ...
        private void resolveAnchorView(View view, CoordinatorLayout coordinatorLayout) {
            ...
            if (viewFindViewById == null) {
                if (coordinatorLayout.isInEditMode()) {
                    ...
                    StringBuilder sbR = a.r("Could not find CoordinatorLayout descendant view with id ");
                    sbR.append(coordinatorLayout.getResources().getResourceName(this.mAnchorId));
                    sbR.append(" to anchor view ");
                    sbR.append(view);
