...
public class ItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
    ...
    public static abstract class Callback {
        ...
        public int interpolateOutOfBoundsScroll(@NonNull RecyclerView recyclerView, int i2, int i3, int i4, long j2) {
            int interpolation = (int) (sDragScrollInterpolator.getInterpolation(j2 <= DRAG_SCROLL_ACCELERATION_LIMIT_TIME_MS ? j2 / 2000.0f : 1.0f) * ((int) (sDragViewScrollCapInterpolator.getInterpolation(Math.min(1.0f, (Math.abs(i3) * 1.0f) / i2)) * ((int) Math.signum(i3)) * getMaxDragScroll(recyclerView))));
    ...
    public static class RecoverAnimation implements Animator.AnimatorListener {
        ...
        public void update() {
            ...
            if (f2 == f3) {
                ...
                this.mX = a.a(f3, f2, this.mFraction, f2);
            }
            ...
            if (f4 == f5) {
                ...
                this.mY = a.a(f5, f4, this.mFraction, f4);
            }
        }
    }
