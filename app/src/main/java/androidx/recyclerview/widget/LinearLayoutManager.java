...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public static class AnchorInfo {
        ...
        public String toString() {
            StringBuilder sbR = a.r("AnchorInfo{mPosition=");
            sbR.append(this.mPosition);
            sbR.append(", mCoordinate=");
            sbR.append(this.mCoordinate);
            sbR.append(", mLayoutFromEnd=");
            sbR.append(this.mLayoutFromEnd);
            sbR.append(", mValid=");
            sbR.append(this.mValid);
    ...
    public void validateChildOrder() {
        ...
        if (this.mShouldReverseLayout) {
            for (int i2 = 1; i2 < getChildCount(); i2++) {
                ...
                if (position2 < position) {
                    logChildren();
                    StringBuilder sbR = a.r("detected invalid position. loc invalid? ");
                    sbR.append(decoratedStart2 < decoratedStart);
        ...
        for (int i3 = 1; i3 < getChildCount(); i3++) {
            ...
            if (position3 < position) {
                logChildren();
                StringBuilder sbR2 = a.r("detected invalid position. loc invalid? ");
                sbR2.append(decoratedStart3 < decoratedStart);
