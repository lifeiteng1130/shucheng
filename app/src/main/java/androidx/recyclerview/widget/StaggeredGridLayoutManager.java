    ...
    */
    ...
    public int[] findFirstCompletelyVisibleItemPositions(int[] iArr) {
        if (iArr == null) {
            ...
            StringBuilder sbR = a.r("Provided int[]'s size must be more than or equal to span count. Expected:");
            sbR.append(this.mSpanCount);
            sbR.append(", array size:");
            sbR.append(iArr.length);
    ...
    public static class LazySpanLookup {
        ...
        public static class FullSpanItem implements Parcelable {
            ...
            public String toString() {
                StringBuilder sbR = a.r("FullSpanItem{mPosition=");
                sbR.append(this.mPosition);
                sbR.append(", mGapDir=");
                sbR.append(this.mGapDir);
                sbR.append(", mHasUnwantedGapAfter=");
                sbR.append(this.mHasUnwantedGapAfter);
                sbR.append(", mGapPerSpan=");
                sbR.append(Arrays.toString(this.mGapPerSpan));
