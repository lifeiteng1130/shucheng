    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View view, int i2, boolean z) {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (iIndexOfChild == -1) {
                    StringBuilder sbR = a.r("Added View has RecyclerView as parent but view is not a real child. Unfiltered index:");
                    sbR.append(this.mRecyclerView.indexOfChild(view));
                    throw new IllegalStateException(a.F(this.mRecyclerView, sbR));
                }
                if (iIndexOfChild != i2) {
        ...
        */
        ...
        public void ignoreView(@NonNull View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                throw new IllegalArgumentException(a.F(this.mRecyclerView, a.r("View should be fully attached to be ignored")));
            }
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@NonNull View view, int i2) {
            ...
            if (childViewHolderInt == null) {
                throw new IllegalArgumentException(a.F(RecyclerView.this, a.r("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter")));
            }
            ...
            if (iFindPositionOffset < 0 || iFindPositionOffset >= RecyclerView.this.mAdapter.getItemCount()) {
                ...
                throw new IndexOutOfBoundsException(a.F(RecyclerView.this, sb));
            }
        ...
        public int convertPreLayoutPositionToPostLayout(int i2) {
            ...
            StringBuilder sbS = a.s("invalid position ", i2, ". State item count is ");
            sbS.append(RecyclerView.this.mState.getItemCount());
            throw new IndexOutOfBoundsException(a.F(RecyclerView.this, sbS));
        }
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i2, boolean z) {
            ...
            throw new IllegalStateException(a.F(RecyclerView.this, sb));
        }
        ...
        */
        ...
        public void scrapView(View view) {
            ...
            if (childViewHolderInt.isInvalid() && !childViewHolderInt.isRemoved() && !RecyclerView.this.mAdapter.hasStableIds()) {
                throw new IllegalArgumentException(a.F(RecyclerView.this, a.r("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
  ...
  0x0165: PHI (r5v3 boolean) = (r5v2 boolean), (r5v5 boolean) binds: [B:28:0x005d, B:59:0x00ed] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static class State {
        ...
        public void assertLayoutStep(int i2) {
            ...
            StringBuilder sbR = a.r("Layout state should be one of ");
            sbR.append(Integer.toBinaryString(i2));
            sbR.append(" but it is ");
            sbR.append(Integer.toBinaryString(this.mLayoutStep));
        ...
        public String toString() {
            StringBuilder sbR = a.r("State{mTargetPosition=");
            sbR.append(this.mTargetPosition);
            sbR.append(", mData=");
            sbR.append(this.mData);
            sbR.append(", mItemCount=");
            sbR.append(this.mItemCount);
            sbR.append(", mIsMeasuring=");
            sbR.append(this.mIsMeasuring);
            sbR.append(", mPreviousLayoutItemCount=");
            sbR.append(this.mPreviousLayoutItemCount);
            sbR.append(", mDeletedInvisibleItemCountSincePreviousLayout=");
            sbR.append(this.mDeletedInvisibleItemCountSincePreviousLayout);
            sbR.append(", mStructureChanged=");
            sbR.append(this.mStructureChanged);
            sbR.append(", mInPreLayout=");
            sbR.append(this.mInPreLayout);
            sbR.append(", mRunSimpleAnimations=");
            sbR.append(this.mRunSimpleAnimations);
            sbR.append(", mRunPredictiveAnimations=");
            sbR.append(this.mRunPredictiveAnimations);
    ...
    public class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int i2, int i3, int i4, int i5) {
            ...
            float f2 = width;
            float f3 = i6;
            float fDistanceInfluenceForSnapDuration = (distanceInfluenceForSnapDuration(Math.min(1.0f, (iSqrt2 * 1.0f) / f2)) * f3) + f3;
            if (iSqrt > 0) {
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            StringBuilder sbT = a.t(getClass().isAnonymousClass() ? "ViewHolder" : getClass().getSimpleName(), "{");
            ...
            if (!isRecyclable()) {
                StringBuilder sbR = a.r(" not recyclable(");
                sbR.append(this.mIsRecyclableCount);
                sbR.append(")");
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (childViewHolderInt != viewHolder && getChangedHolderKey(childViewHolderInt) == j2) {
                ...
                if (adapter == null || !adapter.hasStableIds()) {
                    ...
                    sb.append(" \n View Holder 2:");
                    sb.append(viewHolder);
                    throw new IllegalStateException(a.F(this, sb));
                }
                ...
                throw new IllegalStateException(a.F(this, sb2));
            }
        }
            ...
            public void attachViewToParent(View view, int i2, ViewGroup.LayoutParams layoutParams) {
                ...
                if (childViewHolderInt != null) {
                    if (!childViewHolderInt.isTmpDetached() && !childViewHolderInt.shouldIgnore()) {
                        ...
                        sb.append(childViewHolderInt);
                        throw new IllegalArgumentException(a.F(RecyclerView.this, sb));
                    }
    ...
    */
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str != null) {
            throw new IllegalStateException(a.F(this, a.r(str)));
        }
        throw new IllegalStateException(a.F(this, a.r("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
    }
    ...
    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            ...
            throw new IllegalStateException(a.F(this, a.r("Cannot call this method while RecyclerView is computing a layout or scrolling")));
        }
        if (this.mDispatchScrollCounter > 0) {
            new IllegalStateException(a.F(this, a.r("")));
        }
    }
    ...
    public String exceptionLabel() {
        ...
        sbR.append(", adapter:");
        sbR.append(this.mAdapter);
        sbR.append(", layout:");
        sbR.append(this.mLayout);
        sbR.append(", context:");
        sbR.append(getContext());
        return sbR.toString();
    }
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        throw new IllegalStateException(a.F(this, a.r("RecyclerView has no LayoutManager")));
    }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
            throw new IllegalArgumentException(a.F(this, a.r("Trying to set fast scroller without both required drawables.")));
        }
    ...
    public void setLayoutManager(@Nullable LayoutManager layoutManager) {
        ...
        if (layoutManager != null) {
            if (layoutManager.mRecyclerView != null) {
                ...
                throw new IllegalArgumentException(a.F(layoutManager.mRecyclerView, sb));
            }
