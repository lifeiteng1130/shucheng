...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class ChangeInfo {
        ...
        public String toString() {
            StringBuilder sbR = a.r("ChangeInfo{oldHolder=");
            sbR.append(this.oldHolder);
            sbR.append(", newHolder=");
            sbR.append(this.newHolder);
            sbR.append(", fromX=");
            sbR.append(this.fromX);
            sbR.append(", fromY=");
            sbR.append(this.fromY);
            sbR.append(", toX=");
            sbR.append(this.toX);
            sbR.append(", toY=");
            return a.n(sbR, this.toY, MessageFormatter.DELIM_STOP);
        }
