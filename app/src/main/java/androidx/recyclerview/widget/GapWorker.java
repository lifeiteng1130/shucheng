...
public final class GapWorker implements Runnable {
    ...
    public static class AnonymousClass1 implements Comparator<Task>, j$.util.Comparator {
    ...
    private void flushTaskWithDeadline(Task task, long j2) {
        RecyclerView.ViewHolder viewHolderPrefetchPositionWithDeadline = prefetchPositionWithDeadline(task.view, task.position, task.immediate ? RecyclerView.FOREVER_NS : j2);
