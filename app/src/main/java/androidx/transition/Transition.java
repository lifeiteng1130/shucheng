...
public abstract class Transition implements Cloneable {
    ...
    private static int[] parseMatchOrder(String str) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if ("id".equalsIgnoreCase(strTrim)) {
                ...
                if (!strTrim.isEmpty()) {
                    throw new InflateException(a.k("Unknown match type in matchOrder: '", strTrim, "'"));
                }
    ...
    */
    ...
    public String toString(String str) {
        ...
        if (this.mDuration != -1) {
            StringBuilder sbT = a.t(string, "dur(");
            sbT.append(this.mDuration);
            sbT.append(") ");
            string = sbT.toString();
        }
        if (this.mStartDelay != -1) {
            StringBuilder sbT2 = a.t(string, "dly(");
            sbT2.append(this.mStartDelay);
            sbT2.append(") ");
            string = sbT2.toString();
        }
        if (this.mInterpolator != null) {
            StringBuilder sbT3 = a.t(string, "interp(");
            sbT3.append(this.mInterpolator);
            sbT3.append(") ");
        ...
        if (this.mTargetIds.size() > 0) {
            for (int i2 = 0; i2 < this.mTargetIds.size(); i2++) {
                ...
                sbR2.append(this.mTargetIds.get(i2));
                strI = sbR2.toString();
            }
        }
        if (this.mTargets.size() > 0) {
            for (int i3 = 0; i3 < this.mTargets.size(); i3++) {
                ...
                StringBuilder sbR3 = a.r(strI);
                sbR3.append(this.mTargets.get(i3));
                strI = sbR3.toString();
            }
        }
        return a.i(strI, ")");
