...
public final class LocaleListCompatWrapper implements LocaleListInterface {
    ...
    private static final Locale LOCALE_EN_XA = new Locale(n.DEFAULT_LANGUAGE, "XA");
    ...
    public LocaleListCompatWrapper(@NonNull Locale... localeArr) {
        ...
        for (int i2 = 0; i2 < localeArr.length; i2++) {
            ...
            if (locale == null) {
                throw new NullPointerException(a.d("list[", i2, "] is null"));
            }
            if (hashSet.contains(locale)) {
                throw new IllegalArgumentException(a.d("list[", i2, "] is a repetition"));
            }
