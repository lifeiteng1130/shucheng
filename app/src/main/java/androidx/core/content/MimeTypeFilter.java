...
public final class MimeTypeFilter {
    ...
    public static boolean matches(@Nullable String str, @NonNull String str2) {
        ...
        return mimeTypeAgainstFilter(str.split(w.DEFAULT_PATH_SEPARATOR), str2.split(w.DEFAULT_PATH_SEPARATOR));
    }
    ...
    public static String[] matchesMany(@Nullable String[] strArr, @NonNull String str) {
        ...
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(str2.split(w.DEFAULT_PATH_SEPARATOR), strArrSplit)) {
                arrayList.add(str2);
            }
        }
    ...
    public static String matches(@Nullable String str, @NonNull String[] strArr) {
        ...
        String[] strArrSplit = str.split(w.DEFAULT_PATH_SEPARATOR);
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(strArrSplit, str2.split(w.DEFAULT_PATH_SEPARATOR))) {
                return str2;
            }
        }
        return null;
