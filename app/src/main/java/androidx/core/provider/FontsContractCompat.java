...
public class FontsContractCompat {
    ...
    /* JADX INFO: renamed from: androidx.core.provider.FontsContractCompat$5, reason: invalid class name */
    public class AnonymousClass5 implements Comparator<byte[]>, j$.util.Comparator {
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int i2, @IntRange(from = 1, to = d.a) int i3, boolean z, int i4) {
        ...
        try {
            ...
            if (cursorQuery != null && cursorQuery.getCount() > 0) {
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    arrayList2.add(new FontInfo(columnIndex3 == -1 ? ContentUris.withAppendedId(uriBuild, cursorQuery.getLong(columnIndex2)) : ContentUris.withAppendedId(uriBuild2, cursorQuery.getLong(columnIndex3)), columnIndex4 != -1 ? cursorQuery.getInt(columnIndex4) : 0, columnIndex5 != -1 ? cursorQuery.getInt(columnIndex5) : TinkerReport.KEY_LOADED_SUCC_COST_500_LESS, columnIndex6 != -1 && cursorQuery.getInt(columnIndex6) == 1, i2));
                }
    ...
    public static ProviderInfo getProvider(@NonNull PackageManager packageManager, @NonNull FontRequest fontRequest, @Nullable Resources resources) throws PackageManager.NameNotFoundException {
        ...
        if (providerInfoResolveContentProvider == null) {
            throw new PackageManager.NameNotFoundException(a.i("No package found for authority: ", providerAuthority));
        }
        if (!providerInfoResolveContentProvider.packageName.equals(fontRequest.getProviderPackage())) {
            StringBuilder sbU = a.u("Found content provider ", providerAuthority, ", but package was not ");
            sbU.append(fontRequest.getProviderPackage());
