...
public final class FontRequest {
    ...
    public String toString() {
        ...
        StringBuilder sbR = a.r("FontRequest {mProviderAuthority: ");
        sbR.append(this.mProviderAuthority);
        sbR.append(", mProviderPackage: ");
        sbR.append(this.mProviderPackage);
        sbR.append(", mQuery: ");
        sbR.append(this.mQuery);
        sbR.append(", mCertificates:");
