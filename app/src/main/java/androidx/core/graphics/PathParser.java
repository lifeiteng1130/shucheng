...
public class PathParser {
    ...
    public static Path createPathFromPathData(String str) {
        ...
        try {
            ...
            throw new RuntimeException(a.i("Error in parsing ", str), e2);
        }
    }
    ...
    public static class PathDataNode {
        ...
        private static void arcToBezier(Path path, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9, double d10) {
            ...
            while (i2 < iCeil) {
                ...
                double d26 = (((d11 * dCos) * dCos3) + d2) - (d14 * dSin3);
                double d27 = (d17 * dSin3) + (d11 * dSin * dCos3) + d3;
        ...
        private static void drawArc(Path path, float f2, float f3, float f4, float f5, float f6, float f7, float f8, boolean z, boolean z2) {
            ...
            double d6 = f3;
            double d7 = f6;
            double d8 = ((d6 * dSin) + d5) / d7;
            double d9 = f7;
            double d10 = ((d6 * dCos) + (((double) (-f2)) * dSin)) / d9;
            double d11 = f5;
            ...
            double dAtan2 = Math.atan2(d10 - d3, d8 - d2);
            double dAtan22 = Math.atan2(d13 - d3, d12 - d2) - dAtan2;
            if (z2 != (dAtan22 >= 0.0d)) {
                dAtan22 = dAtan22 > 0.0d ? dAtan22 - 6.283185307179586d : dAtan22 + 6.283185307179586d;
            }
            double d22 = d2 * d7;
            double d23 = d3 * d9;
            arcToBezier(path, (d22 * dCos) - (d23 * dSin), (d23 * dCos) + (d22 * dSin), d7, d9, d4, d6, radians, dAtan2, dAtan22);
        }
