...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        public String toString() {
            ...
            StringBuilder sbR = a.r("textSize=");
            sbR.append(this.mPaint.getTextSize());
            sb.append(sbR.toString());
            sb.append(", textScaleX=" + this.mPaint.getTextScaleX());
            sb.append(", textSkewX=" + this.mPaint.getTextSkewX());
            int i2 = Build.VERSION.SDK_INT;
            StringBuilder sbR2 = a.r(", letterSpacing=");
            sbR2.append(this.mPaint.getLetterSpacing());
            sb.append(sbR2.toString());
            sb.append(", elegantTextHeight=" + this.mPaint.isElegantTextHeight());
            if (i2 >= 24) {
                StringBuilder sbR3 = a.r(", textLocale=");
                sbR3.append(this.mPaint.getTextLocales());
                sb.append(sbR3.toString());
            } else {
                StringBuilder sbR4 = a.r(", textLocale=");
                sbR4.append(this.mPaint.getTextLocale());
                sb.append(sbR4.toString());
            }
            StringBuilder sbR5 = a.r(", typeface=");
            sbR5.append(this.mPaint.getTypeface());
            sb.append(sbR5.toString());
            if (i2 >= 26) {
                StringBuilder sbR6 = a.r(", variationSettings=");
                sbR6.append(this.mPaint.getFontVariationSettings());
                sb.append(sbR6.toString());
            }
            StringBuilder sbR7 = a.r(", textDir=");
            sbR7.append(this.mTextDir);
            sb.append(sbR7.toString());
