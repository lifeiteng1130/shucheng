...
public final class LinkifyCompat {
    ...
    /* JADX INFO: renamed from: androidx.core.text.util.LinkifyCompat$1, reason: invalid class name */
    public class AnonymousClass1 implements Comparator<LinkSpec>, j$.util.Comparator {
        ...
        while (true) {
            try {
                ...
                if (strFindAddress != null && (iIndexOf = string.indexOf(strFindAddress)) >= 0) {
                    ...
                    try {
                        linkSpec.url = "geo:0,0?q=" + URLEncoder.encode(strFindAddress, DataUtil.defaultCharset);
                        arrayList.add(linkSpec);
    ...
    private static String makeUrl(@NonNull String str, @NonNull String[] strArr, Matcher matcher, @Nullable Linkify.TransformFilter transformFilter) {
        ...
        return (z || strArr.length <= 0) ? str : a.p(new StringBuilder(), strArr[0], str);
    }
