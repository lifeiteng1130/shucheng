...
public final class ShareCompat {
    ...
    public static class IntentReader {
        ...
        public Uri getStream(int i2) {
            ...
            StringBuilder sbR = a.r("Stream items available: ");
            sbR.append(getStreamCount());
            sbR.append(" index requested: ");
            sbR.append(i2);
    ...
    public static void configureMenuItem(@NonNull MenuItem menuItem, @NonNull IntentBuilder intentBuilder) {
        ...
        StringBuilder sbR = a.r(HISTORY_FILENAME_PREFIX);
        sbR.append(intentBuilder.getContext().getClass().getName());
        shareActionProvider.setShareHistoryFileName(sbR.toString());
    ...
    public static void configureMenuItem(@NonNull Menu menu, @IdRes int i2, @NonNull IntentBuilder intentBuilder) {
        ...
        throw new IllegalArgumentException(a.d("Could not find menu item with id ", i2, " in the supplied menu"));
    }
}
