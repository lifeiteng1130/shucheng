...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
        ...
        if (this.mAddToBackStack) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (fragment != null) {
                    ...
                    if (FragmentManager.isLoggingEnabled(2)) {
                        StringBuilder sbR = a.r("Bump nesting of ");
                        sbR.append(op.mFragment);
                        sbR.append(" to ");
                        sbR.append(op.mFragment.mBackStackNesting);
                        sbR.toString();
                    }
                }
            }
    ...
    public FragmentTransaction detach(@NonNull Fragment fragment) {
        ...
        StringBuilder sbR = a.r("Cannot detach Fragment attached to a different FragmentManager. Fragment ");
        sbR.append(fragment.toString());
        sbR.append(" is already attached to a FragmentManager.");
    ...
    public void executeOps() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            switch (op.mCmd) {
                ...
                case 2:
                default:
                    StringBuilder sbR = a.r("Unknown cmd: ");
                    sbR.append(op.mCmd);
    ...
    */
    ...
    public FragmentTransaction hide(@NonNull Fragment fragment) {
        ...
        StringBuilder sbR = a.r("Cannot hide Fragment attached to a different FragmentManager. Fragment ");
        sbR.append(fragment.toString());
        sbR.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(sbR.toString());
    }
    ...
    public FragmentTransaction remove(@NonNull Fragment fragment) {
        ...
        StringBuilder sbR = a.r("Cannot remove Fragment attached to a different FragmentManager. Fragment ");
        sbR.append(fragment.toString());
        sbR.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(sbR.toString());
    }
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        if (fragment.mFragmentManager != this.mManager) {
            StringBuilder sbR = a.r("Cannot setMaxLifecycle for Fragment not attached to FragmentManager ");
            sbR.append(this.mManager);
            throw new IllegalArgumentException(sbR.toString());
        }
    ...
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        ...
        StringBuilder sbR = a.r("Cannot setPrimaryNavigation for Fragment attached to a different FragmentManager. Fragment ");
        sbR.append(fragment.toString());
        sbR.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(sbR.toString());
    }
    ...
    public FragmentTransaction show(@NonNull Fragment fragment) {
        ...
        StringBuilder sbR = a.r("Cannot show Fragment attached to a different FragmentManager. Fragment ");
        sbR.append(fragment.toString());
        sbR.append(" is already attached to a FragmentManager.");
        throw new IllegalStateException(sbR.toString());
    }
