...
public class FragmentStateManager {
    ...
    public void activityCreated() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbR = a.r("moveto ACTIVITY_CREATED: ");
    ...
    public void attach() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbR = a.r("moveto ATTACHED: ");
            sbR.append(this.mFragment);
            sbR.toString();
        }
        Fragment fragment = this.mFragment;
        ...
        if (fragment2 != null) {
            ...
            if (fragmentStateManager2 == null) {
                StringBuilder sbR2 = a.r("Fragment ");
                sbR2.append(this.mFragment);
                sbR2.append(" declared target fragment ");
                sbR2.append(this.mFragment.mTarget);
                sbR2.append(" that does not belong to this FragmentManager!");
            ...
            if (str != null && (fragmentStateManager = this.mFragmentStore.getFragmentStateManager(str)) == null) {
                StringBuilder sbR3 = a.r("Fragment ");
                sbR3.append(this.mFragment);
                sbR3.append(" declared target fragment ");
                throw new IllegalStateException(a.p(sbR3, this.mFragment.mTargetWho, " that does not belong to this FragmentManager!"));
            }
        }
    ...
    public int computeExpectedState() {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            StringBuilder sbS = a.s("computeExpectedState() of ", iMin, " for ");
            sbS.append(this.mFragment);
            sbS.toString();
        }
        return iMin;
    }
    ...
    public void create() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbR = a.r("moveto CREATED: ");
            sbR.append(this.mFragment);
            sbR.toString();
        }
        Fragment fragment = this.mFragment;
    ...
    public void createView() {
        ...
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbR = a.r("moveto CREATE_VIEW: ");
            sbR.append(this.mFragment);
            sbR.toString();
        }
        Fragment fragment = this.mFragment;
        ...
        if (viewGroup2 != null) {
            ...
            if (i2 != 0) {
                if (i2 == -1) {
                    StringBuilder sbR2 = a.r("Cannot create fragment ");
                    sbR2.append(this.mFragment);
                    sbR2.append(" for a container view with no id");
                ...
                if (viewGroup == null) {
                    ...
                    if (!fragment3.mRestored) {
                        ...
                        StringBuilder sbR3 = a.r("No view found for id 0x");
                        sbR3.append(Integer.toHexString(this.mFragment.mContainerId));
                        sbR3.append(" (");
                        sbR3.append(resourceName);
                        sbR3.append(") for fragment ");
                        sbR3.append(this.mFragment);
            ...
            if (FragmentManager.USE_STATE_MANAGER) {
                ...
                if (fragment8.mContainer != null && visibility == 0) {
                    ...
                    if (viewFindFocus != null) {
                        ...
                        if (FragmentManager.isLoggingEnabled(2)) {
                            String str = "requestFocus: Saved focused view " + viewFindFocus + " for Fragment " + this.mFragment;
                        }
                    }
    ...
    public void destroy() {
        ...
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbR = a.r("movefrom CREATED: ");
            sbR.append(this.mFragment);
            sbR.toString();
        }
        Fragment fragment = this.mFragment;
    ...
    public void destroyFragmentView() {
        View view;
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbR = a.r("movefrom CREATE_VIEW: ");
            sbR.append(this.mFragment);
            sbR.toString();
        }
        Fragment fragment = this.mFragment;
    ...
    public void detach() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbR = a.r("movefrom ATTACHED: ");
            sbR.append(this.mFragment);
            sbR.toString();
        }
        ...
        if (z || this.mFragmentStore.getNonConfig().shouldDestroy(this.mFragment)) {
            if (FragmentManager.isLoggingEnabled(3)) {
                StringBuilder sbR2 = a.r("initState called for fragment: ");
                sbR2.append(this.mFragment);
                sbR2.toString();
            }
    ...
    public void moveToExpectedState() {
        ...
        if (this.mMovingToState) {
            if (FragmentManager.isLoggingEnabled(2)) {
                StringBuilder sbR = a.r("Ignoring re-entrant call to moveToExpectedState() for ");
                sbR.append(getFragment());
                sbR.toString();
                return;
            }
            return;
    ...
    public void pause() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbR = a.r("movefrom RESUMED: ");
            sbR.append(this.mFragment);
            sbR.toString();
        }
    ...
    public void resume() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbR = a.r("moveto RESUMED: ");
            sbR.append(this.mFragment);
            sbR.toString();
        }
    ...
    public void start() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbR = a.r("moveto STARTED: ");
            sbR.append(this.mFragment);
            sbR.toString();
        }
    ...
    public void stop() {
        if (FragmentManager.isLoggingEnabled(3)) {
            StringBuilder sbR = a.r("movefrom STARTED: ");
            sbR.append(this.mFragment);
            sbR.toString();
        }
