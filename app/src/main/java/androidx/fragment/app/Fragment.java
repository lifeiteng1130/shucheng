...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public FragmentContainer createFragmentContainer() {
        return new FragmentContainer() { // from class: androidx.fragment.app.Fragment.4
            ...
            public View onFindViewById(int i2) {
                ...
                sbR.append(Fragment.this);
                sbR.append(" does not have a view");
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        this.mChildFragmentManager.dump(a.i(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public String generateActivityResultKey() {
        StringBuilder sbR = a.r("fragment_");
        sbR.append(this.mWho);
        sbR.append("_rq#");
        sbR.append(this.mNextLocalRequestCode.getAndIncrement());
        return sbR.toString();
    }
    ...
    public ViewModelProvider.Factory getDefaultViewModelProviderFactory() {
        ...
        if (this.mDefaultFactory == null) {
            ...
            if (application == null && FragmentManager.isLoggingEnabled(3)) {
                StringBuilder sbR = a.r("Could not find Application instance from Context ");
                sbR.append(requireContext().getApplicationContext());
                sbR.append(", you will not be able to use AndroidViewModel with the default ViewModelProvider.Factory");
                sbR.toString();
            }
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.h("Fragment ", this, " did not call through to super.onActivityCreated()"));
        }
        restoreViewState();
    ...
    public void performAttach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.h("Fragment ", this, " did not call through to super.onAttach()"));
        }
    ...
    public void performCreate(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.h("Fragment ", this, " did not call through to super.onCreate()"));
        }
    ...
    public void performDestroy() {
        ...
        onDestroy();
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.h("Fragment ", this, " did not call through to super.onDestroy()"));
        }
    }
    ...
    public void performDetach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.h("Fragment ", this, " did not call through to super.onDetach()"));
        }
    ...
    public void performPause() {
        ...
        onPause();
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.h("Fragment ", this, " did not call through to super.onPause()"));
        }
    }
    ...
    public void performResume() {
        ...
        onResume();
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.h("Fragment ", this, " did not call through to super.onResume()"));
        }
    ...
    public void performStart() {
        ...
        onStart();
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.h("Fragment ", this, " did not call through to super.onStart()"));
        }
        LifecycleRegistry lifecycleRegistry = this.mLifecycleRegistry;
    ...
    public void performStop() {
        ...
        onStop();
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.h("Fragment ", this, " did not call through to super.onStop()"));
        }
    }
    ...
    public final Bundle requireArguments() {
        ...
        throw new IllegalStateException(a.h("Fragment ", this, " does not have any arguments."));
    }
    ...
    public final Object requireHost() {
        ...
        throw new IllegalStateException(a.h("Fragment ", this, " not attached to a host."));
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            throw new IllegalStateException(a.h("Fragment ", this, " is not attached to any Fragment or host"));
        }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.h("Fragment ", this, " did not call through to super.onViewStateRestored()"));
        }
        if (this.mView != null) {
