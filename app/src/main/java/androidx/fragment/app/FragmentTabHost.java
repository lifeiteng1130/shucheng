...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            StringBuilder sbR = a.r("FragmentTabHost.SavedState{");
            sbR.append(Integer.toHexString(System.identityHashCode(this)));
            sbR.append(" curTab=");
            return a.p(sbR, this.curTab, "}");
        }
    ...
    private void ensureContent() {
        if (this.mRealTabContent == null) {
            ...
            StringBuilder sbR = a.r("No tab content FrameLayout found for id ");
            sbR.append(this.mContainerId);
