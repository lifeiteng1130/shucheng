...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public void attachController(@NonNull FragmentHostCallback<?> fragmentHostCallback, @NonNull FragmentContainer fragmentContainer, @Nullable final Fragment fragment) {
        ...
        if (obj instanceof ActivityResultRegistryOwner) {
            ...
            String strI = a.i("FragmentManager:", fragment != null ? a.p(new StringBuilder(), fragment.mWho, ":") : "");
            this.mStartActivityForResult = activityResultRegistry.register(a.i(strI, "StartActivityForResult"), new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() { // from class: androidx.fragment.app.FragmentManager.9
            ...
            this.mStartIntentSenderForResult = activityResultRegistry.register(a.i(strI, "StartIntentSenderForResult"), new FragmentIntentSenderContract(), new ActivityResultCallback<ActivityResult>() { // from class: androidx.fragment.app.FragmentManager.10
                @Override // androidx.activity.result.ActivityResultCallback
                public void onActivityResult(ActivityResult activityResult) {
                    LaunchedFragmentInfo launchedFragmentInfoPollFirst = FragmentManager.this.mLaunchedFragments.pollFirst();
                    if (launchedFragmentInfoPollFirst == null) {
            ...
            this.mRequestPermissions = activityResultRegistry.register(a.i(strI, "RequestPermissions"), new ActivityResultContracts.RequestMultiplePermissions(), new ActivityResultCallback<Map<String, Boolean>>() { // from class: androidx.fragment.app.FragmentManager.11
                @Override // androidx.activity.result.ActivityResultCallback
                @SuppressLint({"SyntheticAccessor"})
    ...
    */
    ...
    public void putFragment(@NonNull Bundle bundle, @NonNull String str, @NonNull Fragment fragment) {
        if (fragment.mFragmentManager != this) {
            throwException(new IllegalStateException(a.h("Fragment ", fragment, " is not currently in the FragmentManager")));
        }
    ...
    public void restoreSaveState(@Nullable Parcelable parcelable) {
        ...
        for (FragmentState fragmentState : fragmentManagerState.mActive) {
            if (fragmentState != null) {
                ...
                fragment.mFragmentManager = this;
                if (isLoggingEnabled(2)) {
                    StringBuilder sbR = a.r("restoreSaveState: active (");
                    sbR.append(fragment.mWho);
                    sbR.append("): ");
                    sbR.append(fragment);
                    sbR.toString();
                }
        ...
        if (fragmentManagerState.mBackStack != null) {
            ...
            while (true) {
                ...
                if (isLoggingEnabled(2)) {
                    StringBuilder sbS = a.s("restoreAllState: back stack #", i2, " (index ");
                    sbS.append(backStackRecordInstantiate.mIndex);
                    sbS.append("): ");
                    sbS.append(backStackRecordInstantiate);
                    sbS.toString();
                    PrintWriter printWriter = new PrintWriter(new LogWriter(TAG));
        ...
        if (arrayList != null) {
            for (int i3 = 0; i3 < arrayList.size(); i3++) {
                this.mResults.put(arrayList.get(i3), fragmentManagerState.mResults.get(i3));
            }
        }
    ...
    public Parcelable saveAllState() {
        ...
        if (arrayList != null && (size = arrayList.size()) > 0) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (isLoggingEnabled(2)) {
                    StringBuilder sbS = a.s("saveAllState: adding back stack #", i2, ": ");
                    sbS.append(this.mBackStack.get(i2));
                    sbS.toString();
                }
            }
        }
