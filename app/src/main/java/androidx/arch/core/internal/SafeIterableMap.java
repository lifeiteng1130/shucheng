...
public class SafeIterableMap<K, V> implements Iterable<Map.Entry<K, V>>, Iterable {
    ...
    public static class Entry<K, V> implements Map.Entry<K, V>, Map.Entry {
    ...
    public class IteratorWithAdditions implements Iterator<Map.Entry<K, V>>, SupportRemove<K, V>, j$.util.Iterator {
    ...
    public static abstract class ListIterator<K, V> implements java.util.Iterator<Map.Entry<K, V>>, SupportRemove<K, V>, j$.util.Iterator {
    ...
    public boolean equals(Object obj) {
        ...
        java.util.Iterator<Map.Entry<K, V>> it2 = safeIterableMap.iterator();
    ...
    public V remove(@NonNull K k2) {
        ...
        if (!this.mIterators.isEmpty()) {
            java.util.Iterator<SupportRemove<K, V>> it = this.mIterators.keySet().iterator();
            while (it.hasNext()) {
