...
public final class MediaBrowserCompat {
    ...
    public static class CustomActionResultReceiver extends ResultReceiver {
        ...
        public void onReceiveResult(int i2, Bundle bundle) {
            ...
            StringBuilder sbS = a.s("Unknown result code: ", i2, " (extras=");
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public class MediaServiceConnection implements ServiceConnection {
            ...
            public boolean isCurrent(String str) {
                ...
                StringBuilder sbT = a.t(str, " for ");
                sbT.append(MediaBrowserImplBase.this.mServiceComponent);
                sbT.append(" with mServiceConnection=");
                sbT.append(MediaBrowserImplBase.this.mServiceConnection);
                sbT.append(" this=");
                sbT.append(this);
                sbT.toString();
                return false;
            ...
            public void onServiceConnected(final ComponentName componentName, final IBinder iBinder) {
                postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection.1
                    ...
                    public void run() {
                        boolean z = MediaBrowserCompat.DEBUG;
                        if (z) {
                            StringBuilder sbR = a.r("MediaServiceConnection.onServiceConnected name=");
                            sbR.append(componentName);
                            sbR.append(" binder=");
                            sbR.append(iBinder);
                            sbR.toString();
                        ...
                        if (MediaServiceConnection.this.isCurrent("onServiceConnected")) {
                            ...
                            if (z) {
                                try {
                                    ...
                                    StringBuilder sbR2 = a.r("RemoteException during connect for ");
                                    sbR2.append(MediaBrowserImplBase.this.mServiceComponent);
                                    sbR2.toString();
            ...
            public void onServiceDisconnected(final ComponentName componentName) {
                postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection.2
                    ...
                    public void run() {
                        if (MediaBrowserCompat.DEBUG) {
                            StringBuilder sbR = a.r("MediaServiceConnection.onServiceDisconnected name=");
                            sbR.append(componentName);
                            sbR.append(" this=");
                            sbR.append(this);
                            sbR.append(" mServiceConnection=");
                            sbR.append(MediaBrowserImplBase.this.mServiceConnection);
                            sbR.toString();
                            MediaBrowserImplBase.this.dump();
                        }
        ...
        private static String getStateLabel(int i2) {
            return i2 != 0 ? i2 != 1 ? i2 != 2 ? i2 != 3 ? i2 != 4 ? a.G("UNKNOWN/", i2) : "CONNECT_STATE_SUSPENDED" : "CONNECT_STATE_CONNECTED" : "CONNECT_STATE_CONNECTING" : "CONNECT_STATE_DISCONNECTED" : "CONNECT_STATE_DISCONNECTING";
        }
        ...
        private boolean isCurrent(Messenger messenger, String str) {
            ...
            StringBuilder sbT = a.t(str, " for ");
            sbT.append(this.mServiceComponent);
            sbT.append(" with mCallbacksMessenger=");
            sbT.append(this.mCallbacksMessenger);
            sbT.append(" this=");
            sbT.append(this);
            sbT.toString();
            return false;
        ...
        public void connect() {
            int i2 = this.mState;
            if (i2 != 0 && i2 != 1) {
                throw new IllegalStateException(a.p(a.r("connect() called while neigther disconnecting nor disconnected (state="), getStateLabel(this.mState), ")"));
            }
            this.mState = 2;
            this.mHandler.post(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.1
                ...
                public void run() {
                    ...
                    if (MediaBrowserCompat.DEBUG && mediaBrowserImplBase.mServiceConnection != null) {
                        StringBuilder sbR = a.r("mServiceConnection should be null. Instead it is ");
                        sbR.append(MediaBrowserImplBase.this.mServiceConnection);
                        throw new RuntimeException(sbR.toString());
                    }
                    if (mediaBrowserImplBase.mServiceBinderWrapper != null) {
                        StringBuilder sbR2 = a.r("mServiceBinderWrapper should be null. Instead it is ");
                        sbR2.append(MediaBrowserImplBase.this.mServiceBinderWrapper);
                        throw new RuntimeException(sbR2.toString());
                    }
                    if (mediaBrowserImplBase.mCallbacksMessenger != null) {
                        StringBuilder sbR3 = a.r("mCallbacksMessenger should be null. Instead it is ");
                        sbR3.append(MediaBrowserImplBase.this.mCallbacksMessenger);
                    ...
                    try {
                        ...
                        StringBuilder sbR4 = a.r("Failed binding to service ");
                        sbR4.append(MediaBrowserImplBase.this.mServiceComponent);
                        sbR4.toString();
                    }
                    if (!zBindService) {
                ...
                public void run() {
                    ...
                    if (messenger != null) {
                        try {
                            ...
                            StringBuilder sbR = a.r("RemoteException during connect for ");
                            sbR.append(MediaBrowserImplBase.this.mServiceComponent);
                            sbR.toString();
                        }
                    }
                    MediaBrowserImplBase mediaBrowserImplBase2 = MediaBrowserImplBase.this;
        ...
        public void dump() {
            StringBuilder sbR = a.r("  mServiceComponent=");
            sbR.append(this.mServiceComponent);
            sbR.toString();
            String str = "  mCallback=" + this.mCallback;
            String str2 = "  mRootHints=" + this.mRootHints;
            getStateLabel(this.mState);
            StringBuilder sbR2 = a.r("  mServiceConnection=");
            sbR2.append(this.mServiceConnection);
            sbR2.toString();
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException(a.p(a.r("getExtras() called while not connected (state="), getStateLabel(this.mState), ")"));
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException(a.p(a.r("getRoot() called while not connected(state="), getStateLabel(this.mState), ")"));
        }
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException(a.o(a.r("getServiceComponent() called while not connected (state="), this.mState, ")"));
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            ...
            throw new IllegalStateException(a.o(a.r("getSessionToken() called while not connected(state="), this.mState, ")"));
        }
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserServiceCallbackImpl
        public void onConnectionFailed(Messenger messenger) {
            StringBuilder sbR = a.r("onConnectFailed for ");
            sbR.append(this.mServiceComponent);
            sbR.toString();
        ...
        public void onLoadChildren(Messenger messenger, String str, List<MediaItem> list, Bundle bundle, Bundle bundle2) {
            ...
            if (isCurrent(messenger, "onLoadChildren")) {
                if (MediaBrowserCompat.DEBUG) {
                    StringBuilder sbR = a.r("onLoadChildren for ");
                    sbR.append(this.mServiceComponent);
                    sbR.append(" id=");
                    sbR.append(str);
                    sbR.toString();
        ...
        public void search(@NonNull final String str, final Bundle bundle, @NonNull final SearchCallback searchCallback) {
            if (!isConnected()) {
                throw new IllegalStateException(a.p(a.r("search() called while not connected (state="), getStateLabel(this.mState), ")"));
            }
            try {
                this.mServiceBinderWrapper.search(str, bundle, new SearchResultReceiver(str, bundle, searchCallback, this.mHandler), this.mCallbacksMessenger);
            } catch (RemoteException unused) {
