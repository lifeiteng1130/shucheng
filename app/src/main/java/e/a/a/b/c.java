...
@DebugMetadata(c = "io.legado.app.base.BaseService$execute$1", f = "BaseService.kt", i = {}, l = {19}, m = "invokeSuspend", n = {}, s = {})
public final class c<T> extends g implements p<a0, f.z.d<? super T>, Object> {
    ...
    public c(p<? super a0, ? super f.z.d<? super T>, ? extends Object> pVar, f.z.d<? super c> dVar) {
        super(2, dVar);
        this.$block = pVar;
    }
