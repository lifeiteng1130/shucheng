...
@DebugMetadata(c = "io.legado.app.base.BaseViewModel$execute$1", f = "BaseViewModel.kt", i = {}, l = {24}, m = "invokeSuspend", n = {}, s = {})
public final class d<T> extends g implements p<a0, f.z.d<? super T>, Object> {
    ...
    public d(p<? super a0, ? super f.z.d<? super T>, ? extends Object> pVar, f.z.d<? super d> dVar) {
        super(2, dVar);
        this.$block = pVar;
    }
