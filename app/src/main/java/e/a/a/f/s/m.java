...
@DebugMetadata(c = "io.legado.app.service.help.ReadBook$download$1$2", f = "ReadBook.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
public final class m extends f.z.j.a.g implements f.c0.b.q<a0, Throwable, f.z.d<? super v>, Object> {
    public final /* synthetic */ int $index;
    public int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public m(int i2, f.z.d<? super m> dVar) {
        super(3, dVar);
        this.$index = i2;
    }
    ...
    public final Object invoke(@NotNull a0 a0Var, @NotNull Throwable th, @Nullable f.z.d<? super v> dVar) {
        return new m(this.$index, dVar).invokeSuspend(v.a);
    }
