...
public final class d extends f.c0.c.k implements p<DialogInterface, Integer, v> {
    public final /* synthetic */ RssSourceEditActivity this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d(RssSourceEditActivity rssSourceEditActivity) {
        super(2);
    ...
    public final void invoke(@NotNull DialogInterface dialogInterface, int i2) throws IOException {
        ...
        if (i2 == 0) {
            ...
            int i3 = RssSourceEditActivity.f7540g;
            rssSourceEditActivity.X0(str);
            return;
        }
        if (i2 == 1) {
            RssSourceEditActivity rssSourceEditActivity2 = this.this$0;
            int i4 = RssSourceEditActivity.f7540g;
            rssSourceEditActivity2.Y0();
        } else {
            if (i2 != 2) {
                return;
            }
            RssSourceEditActivity rssSourceEditActivity3 = this.this$0;
            int i5 = RssSourceEditActivity.f7540g;
            InputStream inputStreamOpen = rssSourceEditActivity3.getAssets().open("help/regexHelp.md");
            ...
            FragmentManager supportFragmentManager = rssSourceEditActivity3.getSupportFragmentManager();
