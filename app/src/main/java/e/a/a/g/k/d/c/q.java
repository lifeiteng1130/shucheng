...
public final class q extends f.c0.c.k implements f.c0.b.l<e.a.a.e.a.h<? extends DialogInterface>, f.v> {
    ...
    public static final class a extends f.c0.c.k implements f.c0.b.a<View> {
        ...
        public a(DialogEditTextBinding dialogEditTextBinding, String str) {
            super(0);
        ...
        public final View invoke() {
            ...
            dialogEditTextBinding.f6613b.setHint(R.string.group_name);
            dialogEditTextBinding.f6613b.setText(str);
    ...
    public static final class b extends f.c0.c.k implements f.c0.b.l<DialogInterface, f.v> {
        ...
        public final void invoke2(@NotNull DialogInterface dialogInterface) {
            ...
            RssSourceViewModel rssSourceViewModelQ = GroupManageDialog.Q(this.this$0);
            String str = this.$group;
            Editable text = this.$alertBinding.f6613b.getText();
            String string = text == null ? null : text.toString();
            Objects.requireNonNull(rssSourceViewModelQ);
            f.c0.c.j.e(str, "oldGroup");
            BaseViewModel.a(rssSourceViewModelQ, null, null, new h0(str, string, null), 3, null);
        }
    }
    ...
    public final void invoke2(@NotNull e.a.a.e.a.h<? extends DialogInterface> hVar) {
        ...
        hVar.d(new a(dialogEditTextBindingA, this.$group));
