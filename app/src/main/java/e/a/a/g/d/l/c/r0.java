...
@DebugMetadata(c = "io.legado.app.ui.book.source.manage.BookSourceViewModel$selectionAddToGroups$1", f = "BookSourceViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
public final class r0 extends f.z.j.a.g implements f.c0.b.p<g.b.a0, f.z.d<? super f.v>, Object> {
    public final /* synthetic */ String $groups;
    public final /* synthetic */ List<BookSource> $sources;
    public int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public r0(List<BookSource> list, String str, f.z.d<? super r0> dVar) {
        super(2, dVar);
        this.$sources = list;
        this.$groups = str;
    }
    ...
    public final f.z.d<f.v> create(@Nullable Object obj, @NotNull f.z.d<?> dVar) {
        return new r0(this.$sources, this.$groups, dVar);
    }

    @Override // f.c0.b.p
    @Nullable
    public final Object invoke(@NotNull g.b.a0 a0Var, @Nullable f.z.d<? super f.v> dVar) {
        return ((r0) create(a0Var, dVar)).invokeSuspend(f.v.a);
    }
