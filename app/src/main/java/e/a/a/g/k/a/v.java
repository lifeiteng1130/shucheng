...
@DebugMetadata(c = "io.legado.app.ui.rss.article.RssSortViewModel$switchLayout$1$1", f = "RssSortViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
public final class v extends f.z.j.a.g implements f.c0.b.p<a0, f.z.d<? super f.v>, Object> {
    public final /* synthetic */ RssSource $it;
    public int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public v(RssSource rssSource, f.z.d<? super v> dVar) {
        super(2, dVar);
        this.$it = rssSource;
    }
