...
@DebugMetadata(c = "io.legado.app.ui.book.read.config.SpeakEngineViewModel$importOnLine$1", f = "SpeakEngineViewModel.kt", i = {}, l = {24}, m = "invokeSuspend", n = {}, s = {})
public final class f4 extends f.z.j.a.g implements f.c0.b.p<g.b.a0, f.z.d<? super f.v>, Object> {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public f4(String str, SpeakEngineViewModel speakEngineViewModel, f.z.d<? super f4> dVar) {
        super(2, dVar);
        this.$url = str;
    ...
    public final f.z.d<f.v> create(@Nullable Object obj, @NotNull f.z.d<?> dVar) {
        return new f4(this.$url, this.this$0, dVar);
    }

    @Override // f.c0.b.p
    @Nullable
    public final Object invoke(@NotNull g.b.a0 a0Var, @Nullable f.z.d<? super f.v> dVar) {
        return ((f4) create(a0Var, dVar)).invokeSuspend(f.v.a);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Exception {
        ...
        this.this$0.e(c.b.a.m.f.C5((ResponseBody) obj, "utf-8"));
        return f.v.a;
    }
}
