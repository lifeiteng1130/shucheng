...
public final class u4 extends f.c0.c.k implements f.c0.b.p<DialogInterface, Integer, f.v> {
    public final /* synthetic */ DialogTipConfigBinding $this_with;
    public final /* synthetic */ TipConfigDialog this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public u4(TipConfigDialog tipConfigDialog, DialogTipConfigBinding dialogTipConfigBinding) {
        super(2);
    ...
    public final void invoke(@NotNull DialogInterface dialogInterface, int i2) {
        ...
        this.$this_with.u.setText(rVar.l().get(i2));
