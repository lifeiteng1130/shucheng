...
public final class r extends f.c0.c.k implements f.c0.b.l<e.a.a.e.a.h<? extends DialogInterface>, f.v> {
    ...
    public static final class b extends f.c0.c.k implements f.c0.b.l<DialogInterface, f.v> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public b(DialogEditTextBinding dialogEditTextBinding, List<String> list, e.a.a.h.f fVar, ReplaceRuleActivity replaceRuleActivity) {
            super(1);
            this.$alertBinding = dialogEditTextBinding;
            this.$cacheUrls = list;
            this.$aCache = fVar;
        ...
        public final void invoke2(@NotNull DialogInterface dialogInterface) {
            ...
            if (!list.contains(string)) {
                list.add(0, string);
                fVar.b(replaceRuleActivity.importRecordKey, f.x.e.q(list, ",", null, null, 0, null, null, 62));
            }
    ...
    public static final class c extends f.c0.c.k implements f.c0.b.l<String, f.v> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public c(List<String> list, e.a.a.h.f fVar, ReplaceRuleActivity replaceRuleActivity) {
            super(1);
            this.$cacheUrls = list;
            this.$aCache = fVar;
            this.this$0 = replaceRuleActivity;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public r(ReplaceRuleActivity replaceRuleActivity, List<String> list, e.a.a.h.f fVar) {
        super(1);
        this.this$0 = replaceRuleActivity;
        this.$cacheUrls = list;
        this.$aCache = fVar;
    ...
    public final void invoke2(@NotNull e.a.a.e.a.h<? extends DialogInterface> hVar) {
        ...
        dialogEditTextBindingA.f6613b.setDelCallBack(new c(list, fVar, replaceRuleActivity));
