...
public final class p extends f.c0.c.k implements f.c0.b.l<e.a.a.e.a.h<? extends DialogInterface>, f.v> {
    ...
    public static final class b extends f.c0.c.k implements f.c0.b.l<DialogInterface, f.v> {
        ...
        public final void invoke2(@NotNull DialogInterface dialogInterface) {
            ...
            ReplaceRuleViewModel replaceRuleViewModelN = GroupManageDialog.N(this.this$0);
            ...
            BaseViewModel.a(replaceRuleViewModelN, null, null, new f0(str, string, null), 3, null);
        }
    }
    ...
    public final void invoke2(@NotNull e.a.a.e.a.h<? extends DialogInterface> hVar) {
        ...
        String str = this.$group;
        dialogEditTextBindingA.f6613b.setHint("分组名称");
        dialogEditTextBindingA.f6613b.setText(str);
