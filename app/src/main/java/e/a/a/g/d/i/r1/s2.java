...
public final class s2 extends f.c0.c.k implements f.c0.b.l<Integer, f.v> {
    public final /* synthetic */ View $it;
    public final /* synthetic */ ClickActionConfigDialog this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public s2(ClickActionConfigDialog clickActionConfigDialog, View view) {
        super(1);
    ...
    public final void invoke(int i2) {
        e.a.a.h.m.i(this.this$0, "clickActionBottomCenter", i2);
        View view = this.$it;
