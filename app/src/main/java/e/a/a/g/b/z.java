...
public final class z extends f.c0.c.k implements f.c0.b.l<e.a.a.e.a.h<? extends DialogInterface>, f.v> {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public z(ImportReplaceRuleActivity importReplaceRuleActivity) {
        super(1);
        this.this$0 = importReplaceRuleActivity;
    }
