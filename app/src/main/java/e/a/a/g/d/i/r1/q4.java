...
public final class q4 extends f.c0.c.k implements f.c0.b.p<DialogInterface, Integer, f.v> {
    ...
    public q4(LinkedHashMap<Integer, String> linkedHashMap, DialogTipConfigBinding dialogTipConfigBinding) {
        super(2);
    ...
    public final void invoke(@NotNull DialogInterface dialogInterface, int i2) {
        ...
        Set<Integer> setKeySet = this.$headerModes.keySet();
        f.c0.c.j.d(setKeySet, "headerModes.keys");
        Object obj = f.x.e.F(setKeySet).get(i2);
        f.c0.c.j.d(obj, "headerModes.keys.toList()[i]");
        ReadBookConfig.INSTANCE.getConfig().setHeaderMode(((Number) obj).intValue());
        this.$this_with.v.setText(this.$headerModes.get(Integer.valueOf(rVar.c())));
