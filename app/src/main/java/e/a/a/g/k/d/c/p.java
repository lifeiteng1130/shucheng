...
public final class p extends f.c0.c.k implements f.c0.b.l<e.a.a.e.a.h<? extends DialogInterface>, f.v> {
    ...
    public static final class b extends f.c0.c.k implements f.c0.b.l<DialogInterface, f.v> {
        ...
        public final void invoke2(@NotNull DialogInterface dialogInterface) {
            ...
            if (!f.h0.k.s(string)) {
                RssSourceViewModel rssSourceViewModelQ = GroupManageDialog.Q(groupManageDialog);
                Objects.requireNonNull(rssSourceViewModelQ);
                f.c0.c.j.e(string, "group");
                BaseViewModel.a(rssSourceViewModelQ, null, null, new t(string, null), 3, null);
            }
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public p(GroupManageDialog groupManageDialog) {
        super(1);
        this.this$0 = groupManageDialog;
    }
